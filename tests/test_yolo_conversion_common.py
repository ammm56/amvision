...
def test_yolo_conversion_common_resolves_phase_and_options() -> None:
...
def test_yolo_conversion_common_resolves_precision_options() -> None:
...
def test_yolo_conversion_common_builds_output_base_name() -> None:
...
def test_yolo_conversion_common_optimizes_onnx_model(tmp_path: Path) -> None:
...
def test_yolo_conversion_common_rejects_failed_onnx_simplify(tmp_path: Path) -> None:
