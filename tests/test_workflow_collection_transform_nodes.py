...
def _build_collection_transform_template() -> WorkflowGraphTemplate:
    ...
    return WorkflowGraphTemplate(
        ...
        nodes=(
            ...
            WorkflowGraphNode(
                node_id="summary_names_field",
                node_type_id="core.logic.object-field",
                parameters={"key": "names"},
            ),
            WorkflowGraphNode(
                node_id="summary_total_field",
                node_type_id="core.logic.object-field",
                parameters={"key": "score_total"},
            ),
            WorkflowGraphNode(
                node_id="build_summary",
                node_type_id="core.logic.object-build",
                parameters={"fields": {"status": "reviewed"}},
            ),
            WorkflowGraphNode(
                node_id="override_status_field",
                node_type_id="core.logic.object-field",
                parameters={"key": "status"},
            ),
            WorkflowGraphNode(
                node_id="override_owner_field",
                node_type_id="core.logic.object-field",
                parameters={"key": "owner"},
            ),
            WorkflowGraphNode(node_id="build_override", node_type_id="core.logic.object-build"),
            WorkflowGraphNode(
                node_id="merge_summary",
                node_type_id="core.logic.object-merge-pair",
                parameters={"conflict_policy": "overwrite"},
            ),
        ),
        edges=(
            WorkflowGraphEdge(
            ...
            WorkflowGraphEdge(
                edge_id="edge-map-names-summary-field",
                source_node_id="map_names",
                source_port="value",
                target_node_id="summary_names_field",
                target_port="value",
            ),
            WorkflowGraphEdge(
                edge_id="edge-reduce-scores-summary-field",
                source_node_id="reduce_scores",
                source_port="value",
                target_node_id="summary_total_field",
                target_port="value",
            ),
            WorkflowGraphEdge(
                edge_id="edge-summary-names-field-build-summary",
                source_node_id="summary_names_field",
                source_port="field",
                target_node_id="build_summary",
                target_port="entries",
            ),
            WorkflowGraphEdge(
                edge_id="edge-summary-total-field-build-summary",
                source_node_id="summary_total_field",
                source_port="field",
                target_node_id="build_summary",
                target_port="entries",
            ),
            WorkflowGraphEdge(
                edge_id="edge-override-status-field-build-override",
                source_node_id="override_status_field",
                source_port="field",
                target_node_id="build_override",
                target_port="entries",
            ),
            WorkflowGraphEdge(
                edge_id="edge-override-owner-field-build-override",
                source_node_id="override_owner_field",
                source_port="field",
                target_node_id="build_override",
                target_port="entries",
            ),
        ...
        template_inputs=(
            ...
            WorkflowGraphInput(
                ...
                payload_type_id="value.v1",
                target_node_id="override_status_field",
                target_port="value",
            ),
            WorkflowGraphInput(
                input_id="owner",
                display_name="Owner",
                payload_type_id="value.v1",
                target_node_id="override_owner_field",
                target_port="value",
            ),
        ),
        template_outputs=(
