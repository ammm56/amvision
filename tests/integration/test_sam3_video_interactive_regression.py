...
def _build_four_object_frame_window_payload(
    *,
    frame_count: int,
    width: int,
    height: int,
    ...
    for frame_index in range(frame_count):
        ...
        registered_image = image_registry.register_image_bytes(
            ...
            width=width,
            height=height,
            created_by_node_id=f"fixture-sam3-four-{frame_index}",
        )
        frame_items.append(
            {
                "frame_index": frame_index,
    ...
    return _wrap_frame_window_payload(
        ...
        height=height,
        fps=10.0,
        local_path="W:/videos/sam3-four-object-attention-regression.mp4",
    ), image_registry
