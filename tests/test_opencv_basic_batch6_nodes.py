...
def test_opencv_basic_batch6_draw_contours_lines_and_measurements_execute(tmp_path: Path) -> None:
    ...
    template = WorkflowGraphTemplate(
        ...
        nodes=(
            ...
            WorkflowGraphNode(
                node_id="point_distance_item",
                node_type_id="core.logic.list-item",
                parameters={"index": 0},
            ),
            WorkflowGraphNode(
                node_id="slot_width_item",
                node_type_id="core.logic.list-item",
                parameters={"index": 1},
            ),
            WorkflowGraphNode(node_id="measurement_list", node_type_id="core.logic.list-build"),
        ...
        edges=(
            ...
            WorkflowGraphEdge(
                edge_id="edge-point-distance-item-b6",
                source_node_id="point_distance",
                source_port="summary",
                target_node_id="point_distance_item",
                target_port="value",
            ),
            WorkflowGraphEdge(
                edge_id="edge-slot-width-item-b6",
                source_node_id="slot_width",
                source_port="summary",
                target_node_id="slot_width_item",
                target_port="value",
            ),
            WorkflowGraphEdge(
                edge_id="edge-point-distance-item-list-b6",
                source_node_id="point_distance_item",
                source_port="item",
                target_node_id="measurement_list",
                target_port="entries",
            ),
            WorkflowGraphEdge(
                edge_id="edge-slot-width-item-list-b6",
                source_node_id="slot_width_item",
                source_port="item",
                target_node_id="measurement_list",
                target_port="entries",
            ),
