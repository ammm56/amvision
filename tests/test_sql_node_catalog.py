...
def test_sql_node_catalog_builder_matches_checked_in_catalog() -> None:
...
def test_repository_sql_node_pack_is_enabled_by_default() -> None:
    ...
    assert {"custom.database.sql.upsert"}.issubset(loaded_node_type_ids)
