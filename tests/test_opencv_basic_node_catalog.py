...
from custom_nodes.opencv_nodes.categories.basic.workflow.catalog_builder import build_custom_node_catalog_payload
...
def test_opencv_basic_node_catalog_builder_matches_checked_in_catalog() -> None:
    ...
    workflow_dir = repository_root / "custom_nodes" / "opencv_nodes" / "categories" / "basic" / "workflow"
