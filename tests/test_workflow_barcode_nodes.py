...
from custom_nodes.barcode_nodes.specs import (
...
def test_repository_barcode_nodes_decode_expected_symbol(
    tmp_path: Path,
    node_type_id: str,
...
def test_repository_barcode_protocol_node_pack_is_enabled_by_default() -> None:
    ...
    assert "barcode.nodes" in node_pack_ids
    assert {
