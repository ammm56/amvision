...
BACKEND_MODULES: tuple[str, ...] = (
    ...
    "backend.service.application.models.yolo11_detection_model",
    "backend.service.application.models.yolo11_model_service",
    "backend.service.application.models.yolo26_detection_model",
    "backend.service.application.models.yolo26_model_service",
    "backend.service.application.models.yolov8_detection_model",
