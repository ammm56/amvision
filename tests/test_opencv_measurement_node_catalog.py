...
from custom_nodes.opencv_nodes.categories.measurement.workflow.catalog_builder import (
...
def test_opencv_measurement_node_catalog_builder_matches_checked_in_catalog() -> None:
    ...
    workflow_dir = repository_root / "custom_nodes" / "opencv_nodes" / "categories" / "measurement" / "workflow"
