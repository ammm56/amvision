...
from custom_nodes.opencv_nodes.categories.matching.workflow.catalog_builder import (
...
def test_opencv_matching_node_catalog_builder_matches_checked_in_catalog() -> None:
    ...
    assert {
        ...
        "custom.opencv.sift-keypoints",
        "custom.opencv.akaze-keypoints",
        "custom.opencv.brisk-keypoints",
        "custom.opencv.flann-match",
