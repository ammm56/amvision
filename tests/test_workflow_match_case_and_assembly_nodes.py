...
def _build_match_case_template() -> WorkflowGraphTemplate:
    ...
    return WorkflowGraphTemplate(
        ...
        nodes=(
            ...
            WorkflowGraphNode(
                node_id="case_medium_then_field",
                node_type_id="core.logic.object-field",
                parameters={"key": "then"},
            ),
            WorkflowGraphNode(
            ...
            WorkflowGraphNode(
                node_id="case_active_then_field",
                node_type_id="core.logic.object-field",
                parameters={"key": "then"},
            ),
            WorkflowGraphNode(
            ...
            WorkflowGraphNode(
                node_id="case_high_item",
                node_type_id="core.logic.list-item",
                parameters={"index": 0},
            ),
            WorkflowGraphNode(
                node_id="case_medium_item",
                node_type_id="core.logic.list-item",
                parameters={"index": 1},
            ),
            WorkflowGraphNode(
                node_id="case_active_item",
                node_type_id="core.logic.list-item",
                parameters={"index": 2},
            ),
            WorkflowGraphNode(node_id="build_cases", node_type_id="core.logic.list-build"),
            WorkflowGraphNode(node_id="match_value", node_type_id="core.logic.match-case"),
            WorkflowGraphNode(
                node_id="reduce_item_1_entry",
                node_type_id="core.logic.list-item",
                parameters={"index": 0},
            ),
            WorkflowGraphNode(
                node_id="reduce_item_2_entry",
                node_type_id="core.logic.list-item",
                parameters={"index": 1},
            ),
            WorkflowGraphNode(
                node_id="reduce_item_3_entry",
                node_type_id="core.logic.list-item",
                parameters={"index": 2},
            ),
            WorkflowGraphNode(node_id="build_reduce_items", node_type_id="core.logic.list-build"),
            WorkflowGraphNode(
        ...
        edges=(
            WorkflowGraphEdge(
                edge_id="edge-target-score-field-build-target",
                source_node_id="target_score_field",
                source_port="field",
                target_node_id="build_target",
                target_port="entries",
            ),
            WorkflowGraphEdge(
                edge_id="edge-target-state-field-build-target",
                source_node_id="target_state_field",
                source_port="field",
                target_node_id="build_target",
                target_port="entries",
            ),
            ...
            WorkflowGraphEdge(
                edge_id="edge-case-high-field-to-case",
                source_node_id="case_high_then_field",
                source_port="field",
                target_node_id="build_case_high",
                target_port="entries",
            ),
            WorkflowGraphEdge(
                edge_id="edge-case-medium-field-to-case",
                source_node_id="case_medium_then_field",
                source_port="field",
                target_node_id="build_case_medium",
                target_port="entries",
            ),
            WorkflowGraphEdge(
                edge_id="edge-case-active-field-to-case",
                source_node_id="case_active_then_field",
                source_port="field",
                target_node_id="build_case_active",
                target_port="entries",
            ),
            WorkflowGraphEdge(
                edge_id="edge-case-high-to-item",
                source_node_id="build_case_high",
                source_port="value",
                target_node_id="case_high_item",
                target_port="value",
            ),
            WorkflowGraphEdge(
                edge_id="edge-case-medium-to-item",
                source_node_id="build_case_medium",
                source_port="value",
                target_node_id="case_medium_item",
                target_port="value",
            ),
            WorkflowGraphEdge(
                edge_id="edge-case-active-to-item",
                source_node_id="build_case_active",
                source_port="value",
                target_node_id="case_active_item",
                target_port="value",
            ),
            WorkflowGraphEdge(
                edge_id="edge-case-high-item-to-cases",
                source_node_id="case_high_item",
                source_port="item",
                target_node_id="build_cases",
                target_port="entries",
            ),
            WorkflowGraphEdge(
                edge_id="edge-case-medium-item-to-cases",
                source_node_id="case_medium_item",
                source_port="item",
                target_node_id="build_cases",
                target_port="entries",
            ),
            WorkflowGraphEdge(
                edge_id="edge-case-active-item-to-cases",
                source_node_id="case_active_item",
                source_port="item",
                target_node_id="build_cases",
                target_port="entries",
            ),
            ...
            WorkflowGraphEdge(
                edge_id="edge-reduce-item-1-to-list",
                source_node_id="reduce_item_1_entry",
                source_port="item",
                target_node_id="build_reduce_items",
                target_port="entries",
            ),
            WorkflowGraphEdge(
                edge_id="edge-reduce-item-2-to-list",
                source_node_id="reduce_item_2_entry",
                source_port="item",
                target_node_id="build_reduce_items",
                target_port="entries",
            ),
            WorkflowGraphEdge(
                edge_id="edge-reduce-item-3-to-list",
                source_node_id="reduce_item_3_entry",
                source_port="item",
                target_node_id="build_reduce_items",
                target_port="entries",
            ),
        ...
        template_inputs=(
            WorkflowGraphInput(
                ...
                target_node_id="target_score_field",
                target_port="value",
            ),
            WorkflowGraphInput(
                ...
                payload_type_id="value.v1",
                target_node_id="target_state_field",
                target_port="value",
            ),
            WorkflowGraphInput(
                ...
                payload_type_id="value.v1",
                target_node_id="case_high_then_field",
                target_port="value",
            ),
            WorkflowGraphInput(
                ...
                payload_type_id="value.v1",
                target_node_id="case_medium_then_field",
                target_port="value",
            ),
            WorkflowGraphInput(
                ...
                payload_type_id="value.v1",
                target_node_id="case_active_then_field",
                target_port="value",
            ),
            WorkflowGraphInput(
            ...
            WorkflowGraphInput(
                ...
                payload_type_id="value.v1",
                target_node_id="reduce_item_1_entry",
                target_port="value",
            ),
            WorkflowGraphInput(
                ...
                payload_type_id="value.v1",
                target_node_id="reduce_item_2_entry",
                target_port="value",
            ),
            WorkflowGraphInput(
                ...
                payload_type_id="value.v1",
                target_node_id="reduce_item_3_entry",
                target_port="value",
            ),
        ),
        template_outputs=(
