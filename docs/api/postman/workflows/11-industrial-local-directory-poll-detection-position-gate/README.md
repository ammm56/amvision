# 11 Directory Poll Detection Position Gate 调试说明

## 文档目的

本目录用于说明 `11-industrial-local-directory-poll-detection-position-gate.postman_collection.json` 的实际导入、改值和联调顺序。
