...
- project_id
- display_name
- trigger_kind，当前合同取值为 directory-poll、directory-watch、plc-register、mqtt-topic、zeromq-topic、grpc-method、io-change、sensor-read、schedule、webhook、http-api
- workflow_runtime_id
...
- `workflow-result.v1` payload contract 已实现。
