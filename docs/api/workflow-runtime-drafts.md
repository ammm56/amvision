...
flowchart LR
	...
	B1 --> B5[execution-policies]
	C[未来扩展] --> C4[trigger-sources]
...
5. [docs/api/workflow-execution-policies.md](workflow-execution-policies.md)
6. [docs/architecture/workflow-runtime-phase1.md](../architecture/workflow-runtime-phase1.md)
7. [docs/api/workflow-trigger-sources.md](workflow-trigger-sources.md)
