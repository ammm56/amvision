...
- [docs/api/postman/workflows/08-plc-register-modbus-tcp-async-result-record/08-plc-register-modbus-tcp-async-result-record.postman_collection.json](postman/workflows/08-plc-register-modbus-tcp-async-result-record/08-plc-register-modbus-tcp-async-result-record.postman_collection.json)：第八类 `plc-register` Modbus TCP polling + async submit + result-record / http-request 回传联调 collection
