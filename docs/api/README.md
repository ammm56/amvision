...
App Runtime 的 JSON、文本、图片、文件和多文件统一输入契约见 [Workflow App 输入契约](../architecture/workflows/app-inputs.md)。HTTP Runtime 支持六类输入，ZeroMQ/本机共享内存支持图片引用、JSON 值和文本；API 字段以当前 OpenAPI 为准。
