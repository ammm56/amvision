...
本目录把 AMVision 已实现和规划中的后端能力整理为可直接用于前端概念设计、页面生成和设计评审的提示文档。主要面向两类工具：
...
8. [Vue 3 前端实现交接](08-vue-implementation-handoff.md)：30 个页面到路由、组件、权限、API、共享状态和实现顺序的映射。
9. [ChatGPT Image 2 设计图](generated/README.md)：已生成并核对的浅色/深色基线、标准页面和状态变体。
