...
- [模型支持矩阵](support-matrix.md)
- [模型 Core 架构](../../architecture/models/model-core.md)
- [模型工作流边界](../../architecture/models/workflow-boundaries.md)
- [训练与评估契约](../../architecture/models/training-evaluation.md)
- [部署运行时配置](../../architecture/models/deployment-runtime.md)
