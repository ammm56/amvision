...
- RF-DETR detection 训练执行：`backend/service/application/models/rfdetr_training.py`
...
- RF-DETR segmentation 训练执行：`backend/service/application/models/rfdetr_segmentation_training.py`
