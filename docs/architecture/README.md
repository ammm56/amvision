...
- [docs/architecture/ddp-training-backend-plan.md](ddp-training-backend-plan.md)：生产级 DDP 多 GPU 训练的目标边界、实现顺序、rank0 产物规则和验收标准
...
7. [docs/architecture/ddp-training-backend-plan.md](ddp-training-backend-plan.md)
8. [docs/architecture/model-training-input-size-rules.md](model-training-input-size-rules.md)
9. [docs/architecture/model-task-naming-boundaries.md](model-task-naming-boundaries.md)
10. [docs/architecture/model-core-implementation-plan.md](model-core-implementation-plan.md)
11. [docs/architecture/model-full-core-audit-checklist.md](model-full-core-audit-checklist.md)
12. [docs/architecture/code-structure-cleanup-plan.md](code-structure-cleanup-plan.md)
13. [docs/architecture/model-workflow-boundaries.md](model-workflow-boundaries.md)
