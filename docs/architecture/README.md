...
- [docs/architecture/model-core-implementation-plan.md](model-core-implementation-plan.md)：固定 YOLOv8 / YOLO11 / YOLO26 / RF-DETR 完整 core 的实现范围，并集中维护 YOLO full core 目录、任务拆分、参考映射和验收规则
...
9. [docs/architecture/yolo-model-plan.md](yolo-model-plan.md)
...
21. [docs/architecture/workflow-runtime-phase2.md](workflow-runtime-phase2.md)
22. [docs/architecture/project-structure.md](project-structure.md)
23. [docs/architecture/backend-service.md](backend-service.md)
24. [docs/architecture/websocket-architecture.md](websocket-architecture.md)
25. [docs/architecture/task-system.md](task-system.md)
26. [docs/architecture/detection-model-rules.md](detection-model-rules.md)
27. [docs/architecture/yolox-module-design.md](yolox-module-design.md)
28. [docs/architecture/frontend-web-ui.md](frontend-web-ui.md)
29. [docs/architecture/frontend-web-ui-structure.md](frontend-web-ui-structure.md)
30. [docs/architecture/frontend-web-ui-startup-session.md](frontend-web-ui-startup-session.md)
31. [docs/architecture/frontend-web-ui-development-readiness.md](frontend-web-ui-development-readiness.md)
32. [docs/architecture/frontend-web-ui-workflows.md](frontend-web-ui-workflows.md)
33. [docs/architecture/node-system.md](node-system.md)
34. [docs/architecture/workflow-json-contracts.md](workflow-json-contracts.md)
35. [docs/architecture/data-and-files.md](data-and-files.md)
36. [docs/architecture/local-buffer-broker.md](local-buffer-broker.md)
37. [docs/architecture/dataset-import-spec.md](dataset-import-spec.md)
38. [docs/architecture/dataset-export-formats.md](dataset-export-formats.md)
39. [docs/architecture/runtime-packaging.md](runtime-packaging.md)
40. 按任务继续进入集成规则或日志专题文档
