...
本文档定义模型接入和现有业务链之间的稳定边界，确保训练、转换、推理、Workflow 节点和 TriggerSource 使用一致的资源、执行与调用分层。
...
模型发布的实例数量、故障隔离、OpenVINO CPU / GPU / NPU 设备参数、TensorRT engine / execution context / CUDA stream 边界和硬件迁移规则，统一见 [模型发布运行时配置](deployment-runtime.md)。本文件只固定资源和调用边界，不重复维护后端参数清单。
...
- [../reference/models/support-matrix.md](../../reference/models/support-matrix.md)
- [模型 Core 架构](model-core.md)
- [workflow-runtime.md](../workflows/runtime.md)
- [workflow-json-contracts.md](../workflows/json-contracts.md)
- [node-system.md](../workflows/node-system.md)
- [../reference/datasets/imports.md](../../reference/datasets/imports.md)
- [../reference/datasets/exports.md](../../reference/datasets/exports.md)
- [task-system.md](../platform/task-system.md)
