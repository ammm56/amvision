...
import type { DefaultConnectionColors, Hoverable, INodeInputSlot, INodeOutputSlot, Point, ReadOnlyRect, ReadOnlySize } from "@litegraph/interfaces"
import type { LGraphNode } from "@litegraph/LGraphNode"
import type { LinkId, LLink } from "@litegraph/LLink"
import type { RerouteId } from "@litegraph/Reroute"
import type { CanvasPointerEvent } from "@litegraph/types/events"
import type { Serialisable, SubgraphIO } from "@litegraph/types/serialisation"

import { SlotShape } from "@litegraph/draw"
import { ConstrainedSize } from "@litegraph/infrastructure/ConstrainedSize"
...
import { SlotBase } from "@litegraph/node/SlotBase"
import { createUuidv4, type UUID } from "@litegraph/utils/uuid"
