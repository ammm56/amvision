...
import type { SubgraphInputEventMap } from "@litegraph/infrastructure/SubgraphInputEventMap"
import type { INodeInputSlot, INodeOutputSlot, Point, ReadOnlyRect } from "@litegraph/interfaces"
