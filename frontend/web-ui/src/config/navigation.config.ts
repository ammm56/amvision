...
export const navigationItems: NavigationItem[] = [
  ...
  { labelKey: 'navigation.workflowGraph', path: '/workflows/graph', icon: 'Blocks', requiredScopes: ['workflows:read'] },
  { labelKey: 'navigation.workflowApps', path: '/workflows/apps', icon: 'Workflow', requiredScopes: ['workflows:read'] },
