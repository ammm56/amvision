        ...
        parameter_schema={
            ...
            "properties": {
                ...
                "max_bytes": {
                    ...
                    "description": "单张图片文件的大小上限；1 MB = 1,048,576 字节，超限时报错，不压缩图片。",
                    "minimum": 1,
                ...
                "max_pixels": {
                    "type": "integer",
                    "title": "Max Resolution (MP)",
                    "description": "单张图片宽 × 高的像素总数上限，也用于空白图片；1 MP = 1,000,000 像素，超限时报错，不缩放图片。",
                    "minimum": 1,
                    "default": DEFAULT_IMAGE_MAX_PIXELS,
                    "x-ui-display-divisor": 1_000_000,
                },
            },
        },
