...
from backend.nodes.core_nodes.support.platform.training_requests import (
    resolve_non_detection_training_request_class,
)
...
def _build_platform_training_request(
    ...
    *,
    ...
    request_cls = resolve_non_detection_training_request_class(
        task_type=task_type,
        model_type=model_type,
    )
    return (
