...
from backend.nodes.core_nodes.support.service import run_deployment_process_status_action


def _model_deployment_stop_handler(request) -> dict[str, object]:
...
CORE_NODE_SPEC = CoreNodeSpec(
    node_definition=NodeDefinition(
        ...
        display_name="Stop Deployment",
        category="core.deployment.runtime",
        description="按 task_type 停止指定 sync 或 async 通道上的 deployment 进程。",
    ...
    handler=_model_deployment_stop_handler,
)
