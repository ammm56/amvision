"""deployment status service node。"""
...
def _model_deployment_status_handler(request) -> dict[str, object]:
...
CORE_NODE_SPEC = CoreNodeSpec(
    node_definition=NodeDefinition(
        ...
        description="按 task_type 读取指定 sync 或 async 通道上的 deployment 进程状态。",
    ...
    handler=_model_deployment_status_handler,
)
