...
from backend.nodes.core_nodes.support.reference_diff import require_regions_with_optional_roi
from backend.nodes.core_nodes.support.region import (
    build_region_binary_mask,
    resolve_region_canvas_size,
)
from backend.nodes.core_nodes.support.roi import build_roi_mask
...
CORE_NODE_SPEC = CoreNodeSpec(
    node_definition=NodeDefinition(
        ...
        category="core.vision.continuity",
