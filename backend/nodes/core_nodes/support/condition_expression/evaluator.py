...
from backend.nodes.core_nodes.support.condition_expression.validators import (
    ...
    require_condition_operator,
)
from backend.nodes.core_nodes.support.logic import compare_values, try_extract_value_by_path
...
def evaluate_condition_expression(
    *,
    ...
    operator = require_condition_operator(
