"""装配 / 对位类 core 节点共享 helper。"""

from __future__ import annotations

from backend.nodes.core_nodes._region_node_support import filter_region_items
...
def read_region_selector(
    ...
    *,
    ...
    track_id = _read_optional_text(raw_value.get("track_id"), field_name=f"{field_name}.track_id")
    ...
    min_score = read_optional_non_negative_number(raw_value.get("min_score"), field_name=f"{field_name}.min_score")
    max_score = read_optional_non_negative_number(raw_value.get("max_score"), field_name=f"{field_name}.max_score")
