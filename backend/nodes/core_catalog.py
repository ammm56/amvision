    ...
    return (
        ...
        WorkflowPayloadContract(
            ...
            json_schema={
                ...
                "required": ["text", "media_type", "charset"],
        ...
        WorkflowPayloadContract(
            ...
            json_schema={
                ...
                "properties": {
                    "transport_kind": {"const": "storage"},
                    "storage_ref": {"const": "object-store"},
                    ...
                    "immutable_version": {"type": "string", "minLength": 1},
                    "metadata": {"type": "object"},
                },
                "required": [
                    "transport_kind",
                    ...
                    "items": {
                        ...
                        "items": {
                            ...
                            "properties": {
                                ...
                                "width": {"type": "number"},
                                "height": {"type": "number"},
                                "long_side": {"type": "number"},
                                "short_side": {"type": "number"},
