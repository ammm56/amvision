...
async def get_segmentation_async_deployment_process_supervisor() -> YoloXDeploymentProcessSupervisor | None:
...
async def get_segmentation_sync_deployment_process_supervisor() -> YoloXDeploymentProcessSupervisor | None:
    from backend.service.api.app import get_app_state
