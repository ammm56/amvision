...
from backend.service.api.rest.v1.routes.pose_training_tasks.controls import (
...
from backend.service.api.rest.v1.routes.pose_training_tasks.responses import (
...
def create_pose_training_task(
    ...
    return submit_pose_training_task(
        body=body,
...
@pose_training_tasks_router.post(
    "/pose/training-tasks/{task_id}/save",
    response_model=TrainingTaskDetailResponse,
)
...
@pose_training_tasks_router.post(
    "/pose/training-tasks/{task_id}/pause",
    response_model=TrainingTaskDetailResponse,
)
...
def resume_pose_training_task(
    ...
    """从完整 latest checkpoint 继续 pose 训练任务。"""
