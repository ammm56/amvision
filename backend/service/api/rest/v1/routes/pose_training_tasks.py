...
@pose_training_tasks_router.get(
    "/pose/training-tasks", response_model=list[TrainingTaskSummaryResponse]
)
def list_pose_training_tasks(
...
@pose_training_tasks_router.get(
    "/pose/training-tasks/{task_id}", response_model=TrainingTaskDetailResponse
)
def get_pose_training_task_detail(
    task_id: str,
    principal: Annotated[AuthenticatedPrincipal, Depends(require_scopes("tasks:read"))],
    session_factory: Annotated[SessionFactory, Depends(get_session_factory)],
) -> TrainingTaskDetailResponse:
...
@pose_training_tasks_router.post(
    "/pose/training-tasks/{task_id}/save", response_model=TrainingTaskDetailResponse
)
def request_pose_training_save(
    task_id: str,
    principal: Annotated[
...
@pose_training_tasks_router.post(
    "/pose/training-tasks/{task_id}/pause", response_model=TrainingTaskDetailResponse
)
...
@pose_training_tasks_router.post(
    "/pose/training-tasks/{task_id}/terminate",
    response_model=TrainingTaskDetailResponse,
)
def request_pose_training_terminate(
    task_id: str,
    principal: Annotated[
        AuthenticatedPrincipal, Depends(require_scopes("tasks:write"))
    ],
...
@pose_training_tasks_router.post(
    "/pose/training-tasks/{task_id}/resume",
    response_model=TrainingTaskSubmissionResponse,
    status_code=status.HTTP_202_ACCEPTED,
)
def resume_pose_training_task(
    task_id: str,
    principal: Annotated[
        AuthenticatedPrincipal, Depends(require_scopes("tasks:write"))
    ],
...
@pose_training_tasks_router.delete(
    "/pose/training-tasks/{task_id}", status_code=status.HTTP_204_NO_CONTENT
)
def delete_pose_training_task(
    task_id: str,
    principal: Annotated[
        AuthenticatedPrincipal, Depends(require_scopes("tasks:write"))
    ],
