...
async def create_pose_inference_task(
    ...
    deployment_process_supervisor: Annotated[YoloXDeploymentProcessSupervisor, Depends(get_pose_async_deployment_process_supervisor)],
    ...
    try:
        ...
        raise InvalidRequestError("pose 推理任务请求格式无效", details={"error": str(e)})
