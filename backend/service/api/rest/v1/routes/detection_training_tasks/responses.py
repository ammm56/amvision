...
def _build_detection_training_task_summary_response(
    ...
    """把 detection 训练 TaskRecord 转成 route 内部摘要响应。"""
...
def _build_detection_training_task_detail_response(
    ...
    """把 detection 训练任务和事件转换为 route 内部详情响应。"""
