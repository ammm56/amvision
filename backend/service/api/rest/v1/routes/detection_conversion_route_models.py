"""detection conversion 路由响应模型与辅助函数。"""
...
def build_detection_conversion_task_summary_response(
    task: object,
    *,
    model_type: str,
...
def build_detection_conversion_task_detail_response(
    task: object,
    events: tuple[object, ...],
    *,
    model_type: str,
    ...
    summary = build_detection_conversion_task_summary_response(task, model_type=model_type)
