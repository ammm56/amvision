...
class YoloV8ModelSpec:
    """描述 YOLOv8 在平台中的稳定模型规格。"""

    model_name: str = "yolov8"
    supported_tasks: tuple[ModelTaskType, ...] = YOLOV8_MODEL_PROFILE.supported_tasks
    supported_scales: tuple[YoloV8ModelScale, ...] = YOLOV8_MODEL_PROFILE.supported_scales
    supported_build_formats: tuple[ModelBuildFormat, ...] = YOLOV8_MODEL_PROFILE.supported_build_formats
    ...
    def resolve_default_dataset_format(self, task_type: str) -> str | None:
        ...
        return YOLOV8_MODEL_PROFILE.resolve_default_dataset_format(task_type)
