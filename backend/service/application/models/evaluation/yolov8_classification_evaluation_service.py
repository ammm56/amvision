...
from backend.service.application.models.evaluation.yolov8_classification_evaluation import (
    ...
    run_yolov8_classification_evaluation,
)
...
class YoloV8ClassificationEvaluationRequest:
...
@dataclass(frozen=True)
class YoloV8ClassificationEvaluationSubmission:
...
@dataclass(frozen=True)
class YoloV8ClassificationEvaluationResult:
...
class SqlAlchemyYoloV8ClassificationEvaluationService:
    ...
    def submit_evaluation_task(
        self,
        request: YoloV8ClassificationEvaluationRequest,
        *,
        created_by: str | None = None,
        display_name: str = "",
    ) -> YoloV8ClassificationEvaluationSubmission:
        ...
        return YoloV8ClassificationEvaluationSubmission(
            task_id=created_task.task_id,
            status="queued",
            queue_name=queue_task.queue_name,
            queue_task_id=queue_task.task_id,
    ...
    def process_evaluation_task(
        ...
        try:
            ...
            eval_result = run_yolov8_classification_evaluation(
                ClassificationEvaluationRequest(
        ...
        task_result = YoloV8ClassificationEvaluationResult(
            task_id=task_id,
            status="succeeded",
            dataset_export_id=dataset_export.dataset_export_id,
            dataset_version_id=dataset_export.dataset_version_id,
    ...
    def _build_request_from_task_record(
        ...
        return YoloV8ClassificationEvaluationRequest(
