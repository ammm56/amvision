"""YOLO 主线 segmentation 数据集级评估任务服务。"""
...
from backend.service.application.models.evaluation.yolo_task_segmentation_evaluation import (
    ...
    run_yolo_task_segmentation_evaluation,
)
...
class YoloTaskSegmentationEvaluationRequest:
    project_id: str
...
@dataclass(frozen=True)
class YoloTaskSegmentationEvaluationSubmission:
    task_id: str
    status: str
    queue_name: str
    queue_task_id: str
...
@dataclass(frozen=True)
class YoloTaskSegmentationEvaluationResult:
    task_id: str
    status: str
    dataset_export_id: str
    dataset_version_id: str
...
class SqlAlchemyYoloTaskSegmentationEvaluationService:
    ...
    def submit_evaluation_task(
        self,
        request: YoloTaskSegmentationEvaluationRequest,
        *,
        created_by: str | None = None,
        display_name: str = "",
    ) -> YoloTaskSegmentationEvaluationSubmission:
        ...
        return YoloTaskSegmentationEvaluationSubmission(
            task_id=created_task.task_id,
            status="queued",
            queue_name=queue_task.queue_name,
            queue_task_id=queue_task.task_id,
    ...
    def process_evaluation_task(
        self,
        task_id: str,
    ) -> YoloTaskSegmentationEvaluationResult:
        ...
        task_result = YoloTaskSegmentationEvaluationResult(
            task_id=task_id,
            status="succeeded",
            dataset_export_id=dataset_export.dataset_export_id,
            dataset_version_id=dataset_export.dataset_version_id,
...
def _run_segmentation_evaluation_for_runtime_target(
    *,
    ...
    return run_yolo_task_segmentation_evaluation(
        SegmentationEvaluationRequest(
            dataset_storage=dataset_storage,
            runtime_target=runtime_target,
            manifest_payload=manifest,
