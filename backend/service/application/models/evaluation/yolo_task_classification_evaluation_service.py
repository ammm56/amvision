...
from backend.service.application.models.evaluation.yolo_task_classification_evaluation import (
    ClassificationEvaluationRequest,
    run_yolo_task_classification_evaluation,
)
...
class YoloTaskClassificationEvaluationRequest:
...
@dataclass(frozen=True)
class YoloTaskClassificationEvaluationSubmission:
...
@dataclass(frozen=True)
class YoloTaskClassificationEvaluationResult:
...
class SqlAlchemyYoloTaskClassificationEvaluationService:
    ...
    def submit_evaluation_task(
        self,
        request: YoloTaskClassificationEvaluationRequest,
        *,
        created_by: str | None = None,
        display_name: str = "",
    ) -> YoloTaskClassificationEvaluationSubmission:
        ...
        return YoloTaskClassificationEvaluationSubmission(
            task_id=created_task.task_id,
            status="queued",
            queue_name=queue_task.queue_name,
            queue_task_id=queue_task.task_id,
    ...
    def process_evaluation_task(
        self,
        task_id: str,
    ) -> YoloTaskClassificationEvaluationResult:
        ...
        try:
            ...
            eval_result = run_yolo_task_classification_evaluation(
                ClassificationEvaluationRequest(
        ...
        task_result = YoloTaskClassificationEvaluationResult(
            task_id=task_id,
            status="succeeded",
            dataset_export_id=dataset_export.dataset_export_id,
            dataset_version_id=dataset_export.dataset_version_id,
