...
class LocalPoseValidationSessionService:
    ...
    def create_session(
        ...
        *,
        ...
        keypoint_confidence_threshold = _resolve_probability(
            request.keypoint_confidence_threshold,
            default=_DEFAULT_KEYPOINT_CONFIDENCE_THRESHOLD,
        )
    ...
    def predict(
        ...
        keypoint_confidence_threshold = _resolve_probability(
            request.keypoint_confidence_threshold,
            default=session.keypoint_confidence_threshold,
        )
        save_result_image = (
...
def _serialize_summary(
    s: PoseValidationPredictionSummary | None,
...
def _build_summary_from_payload(
    payload: object,
) -> PoseValidationPredictionSummary | None:
    if not isinstance(payload, dict):
        return None
