...
def build_yolov8_task_augmentation_options(
    ...
    return YoloV8TaskAugmentationOptions(
        ...
        close_mosaic_epochs=max(0, int(_read_float_option(extra, "close_mosaic", default=10.0))),
...
def apply_yolov8_random_hsv(
    *, imports: Any, image: Any, augmentation_options: YoloV8TaskAugmentationOptions
) -> Any:
    """按独立 H/S/V 增益执行 YOLOv8 task HSV 抖动。"""
...
def transform_yolov8_obb_boxes(
    *,
    ...
    for box_index, box in enumerate(boxes_xywhr):
        ...
        original_box = _points_to_yolov8_xyxy_bbox(
            imports=imports,
            points=corners[:, :2],
            output_size=None,
        )
        ...
        transformed_box = _points_to_yolov8_xyxy_bbox(
            imports=imports,
...
def _points_to_yolov8_xyxy_bbox(
    *,
    imports: Any,
    points: Any,
