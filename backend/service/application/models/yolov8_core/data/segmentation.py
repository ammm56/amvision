...
class YoloV8SegmentationTrainingBatch:
    ...
    def pin_memory(self) -> "YoloV8SegmentationTrainingBatch":
...
def build_yolov8_segmentation_training_batch(
    *,
    ...
    if not training and augmentation_options is not None:
        raise ValueError("YOLOv8 segmentation validation 不允许随机增强")
    if not samples:
        return None
...
def _build_yolov8_segmentation_mosaic_sample(
    *,
    ...
    for placement in placements:
        ...
        placed_target = _build_yolov8_segmentation_sample_targets(
            sample=sample,
