"""RF-DETR core 数据集处理模块：`datasets.o365`。"""
...
from backend.service.application.models.rfdetr_core.datasets.coco import CocoDetection, make_coco_transforms, make_coco_transforms_square_div_64
