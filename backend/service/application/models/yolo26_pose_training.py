...
YOLO26_POSE_IMPLEMENTATION_MODE = "yolo26-pose-core"
YOLO26_POSE_DEFAULT_INPUT_SIZE = (640, 640)
YOLO26_POSE_DEFAULT_BATCH_SIZE = 1
YOLO26_POSE_DEFAULT_MAX_EPOCHS = 1
YOLO26_POSE_DEFAULT_EVAL_INTERVAL = 5
YOLO26_POSE_DEFAULT_LR = 1e-3
YOLO26_POSE_DEFAULT_WEIGHT_DECAY = 1e-4
YOLO26_POSE_DEFAULT_MIN_LR_RATIO = 0.01
YOLO26_POSE_DEFAULT_CLASS_LOSS = 0.5
YOLO26_POSE_DEFAULT_BOX_LOSS = 7.5
YOLO26_POSE_DEFAULT_DFL_LOSS = 1.5
YOLO26_POSE_DEFAULT_KPT_LOSS = 12.0
YOLO26_POSE_DEFAULT_ASSIGN_TOPK = 10
YOLO26_POSE_DEFAULT_ASSIGN_ALPHA = 0.5
YOLO26_POSE_DEFAULT_ASSIGN_BETA = 6.0
YOLO26_POSE_DEFAULT_GRAD_CLIP = 10.0
YOLO26_POSE_DEFAULT_EVAL_CONF = 0.01
YOLO26_POSE_DEFAULT_EVAL_NMS = 0.65
YOLO26_POSE_DEFAULT_KPT_CONF = 0.25


@dataclass(frozen=True)
class Yolo26PoseTrainingExecutionRequest:
    """描述一次 YOLO26 pose 训练执行请求。"""

    dataset_storage: LocalDatasetStorage
    manifest_payload: dict[str, object]
    model_type: str
    model_scale: str
    batch_size: int = YOLO26_POSE_DEFAULT_BATCH_SIZE
    max_epochs: int = YOLO26_POSE_DEFAULT_MAX_EPOCHS
    evaluation_interval: int = YOLO26_POSE_DEFAULT_EVAL_INTERVAL
...
@dataclass(frozen=True)
class Yolo26PoseTrainingExecutionResult:
    """描述一次 YOLO26 pose 训练执行结果。"""
...
def run_yolo26_pose_training(
    ...
    if request.model_type != "yolo26":
        raise InvalidRequestError(
            "YOLO26 pose 训练入口只接受 model_type=yolo26",
            details={"model_type": request.model_type},
        )

    imports = require_yolo26_pose_training_imports()
    device_name = resolve_yolo26_pose_training_device(
    ...
    if (
        ...
        resume_state = load_yolo26_pose_resume_state(
    ...
    assign_beta = float(extra.get("assign_beta", YOLO26_POSE_DEFAULT_ASSIGN_BETA))
    ...
    loop_result = run_yolo26_pose_training_loop(
        ...
        autocast_context=lambda: build_yolo26_pose_autocast_context(
            torch_module=imports.torch,
            precision=precision,
            device_name=device_name,
        ),
    ...
    return Yolo26PoseTrainingExecutionResult(
        ...
        metrics_payload={
            ...
            "implementation_mode": YOLO26_POSE_IMPLEMENTATION_MODE,
        },
...
__all__ = [
    "YOLO26_POSE_IMPLEMENTATION_MODE",
    "Yolo26PoseTrainingControlCommand",
    "Yolo26PoseTrainingEpochProgress",
