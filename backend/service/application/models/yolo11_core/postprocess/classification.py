...
def ensure_yolo11_probability_array(
    *,
    prediction_array: object,
    np_module: Any,
) -> Any:
    """把 YOLO11 classification 输出规整为概率数组。"""
...
def build_yolo11_classification_categories(
    *,
    np_module: Any,
    probabilities: Any,
    logits: Any | None,
    ...
    """把 YOLO11 classification 概率转换为平台 top-k 结果。"""
...
def _to_numpy_2d_array(value: object, *, np_module: Any) -> Any:
    ...
    if array.ndim != 2:
        raise InvalidRequestError(
            "YOLO11 classification 推理输出维度不合法",
