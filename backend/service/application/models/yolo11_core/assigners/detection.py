"""YOLO11 detection target assigner。"""
...
def assign_yolo11_detection_targets(
    *,
    ...
    """按 YOLO11 detection task-aligned 规则分配正样本 anchor。"""
    ...
    inside_mask = _build_yolo11_anchor_inside_mask(
    ...
    pair_iou = yolo11_box_iou_matrix(
        torch_module=torch_module,
        boxes1=gt_boxes,
        boxes2=pred_boxes,
    ).clamp(0.0, 1.0)
...
def yolo11_box_iou_matrix(
    *,
    ...
    return _yolo11_box_ciou_matrix(
        torch_module=torch_module, boxes1=boxes1, boxes2=boxes2
    )


def yolo11_box_iou_aligned(
    *,
    torch_module: Any,
    boxes1: Any,
    boxes2: Any,
...
def _build_yolo11_anchor_inside_mask(
    *,
    ...
    gt_boxes = _expand_yolo11_tiny_gt_boxes_for_assignment(
        torch_module=torch_module,
        gt_boxes=gt_boxes,
        min_stride=min_stride,
        tiny_box_stride=tiny_box_stride,
...
def _expand_yolo11_tiny_gt_boxes_for_assignment(
    *,
    torch_module: Any,
    gt_boxes: Any,
    min_stride: float,
