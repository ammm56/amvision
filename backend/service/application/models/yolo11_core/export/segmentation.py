...
YOLO11_SEGMENTATION_EXPORT_OUTPUT_NAMES = ("predictions", "proto")


def resolve_yolo11_segmentation_export_output_names() -> tuple[str, str]:
    """返回 YOLO11 segmentation 导出输出名。"""

    return YOLO11_SEGMENTATION_EXPORT_OUTPUT_NAMES
    ...
    *,
    ...
    if not isinstance(outputs, list | tuple) or len(outputs) < 2:
        raise ServiceConfigurationError(
            "YOLO11 segmentation export forward 缺少 prediction/proto 双输出",
            details={
