...
def compute_yolo11_segmentation_mask_loss(
    *,
    torch_module: Any,
    prediction: Any | None,
    proto: Any | None,
    ...
    """根据 YOLO11 mask coeff、proto 和 matched GT mask 计算实例 mask loss。"""
    ...
    cropped_loss = crop_yolo11_segmentation_mask_loss(
        torch_module=torch_module,
        mask_loss=mask_loss,
...
def crop_yolo11_segmentation_mask_loss(
    *,
    torch_module: Any,
    mask_loss: Any,
    boxes_xyxy: Any,
    ...
    """按 bbox 裁剪 YOLO11 segmentation mask loss。"""
