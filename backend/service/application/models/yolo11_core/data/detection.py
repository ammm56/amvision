...
def build_yolo11_detection_training_batch(
    *,
    ...
    """把 YOLO11 detection CPU batch 搬运到训练设备。"""

    images, prepared_targets = build_yolo11_detection_training_batch_cpu(
        imports=imports,
        samples=samples,
...
def build_yolo11_detection_training_batch_cpu(
    *,
    imports: Any,
    samples: Sequence[Any],
    input_size: tuple[int, int],
    ...
    """把 YOLO11 detection 样本拼成 CPU batch，供 DataLoader worker 预取。"""
