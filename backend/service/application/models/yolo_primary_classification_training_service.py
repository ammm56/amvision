...
from backend.service.application.models.training.yolo_primary_classification_task_dataset import (
    resolve_yolo_primary_classification_training_dataset_export,
)
from backend.service.application.models.training.yolo_primary_classification_task_events import (
    build_yolo_primary_classification_training_cancelled_event,
    build_yolo_primary_classification_training_failed_event,
    build_yolo_primary_classification_training_paused_event,
    build_yolo_primary_classification_training_queue_failed_event,
    build_yolo_primary_classification_training_queued_event,
    build_yolo_primary_classification_training_started_event,
    build_yolo_primary_classification_training_succeeded_event,
)
from backend.service.application.models.training.yolo_primary_classification_task_control import (
    YoloPrimaryClassificationTrainingControlState,
    build_yolo_primary_classification_training_control_metadata,
    clear_yolo_primary_classification_manual_save_request,
    read_yolo_primary_classification_training_control_state,
)
from backend.service.application.models.training.yolo_primary_classification_task_payload import (
    build_yolo_primary_classification_create_task_metadata,
    build_yolo_primary_classification_queue_payload,
    build_yolo_primary_classification_task_spec,
    read_yolo_primary_classification_task_payload,
)
from backend.service.application.models.training.yolo_primary_classification_task_registration import (
    YOLO_PRIMARY_CLASSIFICATION_MODEL_SERVICE_MAP,
    register_yolo_primary_classification_training_output_model_version,
)
...
class SqlAlchemyYoloPrimaryClassificationTrainingTaskService:
        ...
        try:
            ...
            self.task_service.append_task_event(
                build_yolo_primary_classification_training_cancelled_event(
                    ...
                    control_metadata_key=YOLO_PRIMARY_CLASSIFICATION_TRAINING_CONTROL_METADATA_KEY,
                )
            )
    ...
    def _normalize_model_type(self, model_type: object) -> str:
        ...
        if normalized not in YOLO_PRIMARY_CLASSIFICATION_MODEL_SERVICE_MAP:
            raise InvalidRequestError(
    ...
    def _build_task_spec(
        ...
        *,
        ...
        return build_yolo_primary_classification_task_spec(
            request=request,
            dataset_export=dataset_export,
            model_type=model_type,
        )
    ...
    def _resolve_dataset_export(
        ...
        *,
        ...
        return resolve_yolo_primary_classification_training_dataset_export(
    ...
    def _register_training_output_model_version(
        ...
        *,
        ...
        return register_yolo_primary_classification_training_output_model_version(
            session_factory=self.session_factory,
            task_record=task_record,
            dataset_export=dataset_export,
            payload=payload,
    ...
    def _read_control_state(self, task_id: str) -> YoloPrimaryClassificationTrainingControlState:
        ...
        return read_yolo_primary_classification_training_control_state(
            metadata=metadata,
            control_metadata_key=YOLO_PRIMARY_CLASSIFICATION_TRAINING_CONTROL_METADATA_KEY,
        )
    ...
    def _clear_manual_save_request(self, task_id: str) -> None:
        ...
        task = self.task_service.get_task(task_id).task
        metadata = dict(task.metadata) if task.metadata else {}
        updated_metadata = clear_yolo_primary_classification_manual_save_request(
            metadata=metadata,
            control_metadata_key=YOLO_PRIMARY_CLASSIFICATION_TRAINING_CONTROL_METADATA_KEY,
        )
    ...
    def _set_control_flag(self, task_record: TaskRecord, flag: str, value: bool) -> None:
        ...
        updated_metadata = build_yolo_primary_classification_training_control_metadata(
            metadata=metadata,
            control_metadata_key=YOLO_PRIMARY_CLASSIFICATION_TRAINING_CONTROL_METADATA_KEY,
            flag=flag,
            value=value,
