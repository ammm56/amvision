...
YOLOV8_POSE_MODEL_SERVICE_MAP: dict[str, tuple[type, type]] = {
    "yolov8": (SqlAlchemyYoloV8ModelService, YoloV8TrainingOutputRegistration),
}


def resolve_yolov8_pose_implementation_mode(model_type: str) -> str:
    """按 model_type 返回 pose 训练实现模式。"""

    return YOLOV8_POSE_IMPLEMENTATION_MODE


def register_yolov8_pose_training_output_model_version(
    *,
    ...
    service_cls, registration_cls = YOLOV8_POSE_MODEL_SERVICE_MAP[model_type]
    ...
    return model_service.register_training_output(
        registration_cls(
            ...
            metadata={
                ...
                "implementation_mode": resolve_yolov8_pose_implementation_mode(
                    model_type
                ),
            },
        )
