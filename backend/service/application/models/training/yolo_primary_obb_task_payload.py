...
class YoloPrimaryObbTaskRequestPayload(Protocol):
...
def build_yolo_primary_obb_task_spec(
    *,
    request: YoloPrimaryObbTaskRequestPayload,
...
def build_yolo_primary_obb_create_task_metadata(
    *,
    request: YoloPrimaryObbTaskRequestPayload,
    dataset_export: DatasetExport,
    model_type: str,
...
def build_yolo_primary_obb_queue_payload(
    *,
    task_id: str,
    task_kind: str,
    task_spec: dict[str, object],
...
def read_yolo_primary_obb_task_payload(task_record: TaskRecord) -> dict[str, object]:
