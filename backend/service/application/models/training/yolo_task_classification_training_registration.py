...
YOLO_TASK_CLASSIFICATION_MODEL_SERVICE_MAP: dict[str, tuple[type, type]] = {
...
def register_yolo_task_classification_training_output_model_version(
    *,
    ...
    service_cls, registration_cls = YOLO_TASK_CLASSIFICATION_MODEL_SERVICE_MAP[
        model_type
    ]
    ...
    return model_service.register_training_output(
        registration_cls(
            ...
            metadata={
                ...
                "implementation_mode": YOLO_TASK_CLASSIFICATION_IMPLEMENTATION_MODE,
            },
        )
    )
