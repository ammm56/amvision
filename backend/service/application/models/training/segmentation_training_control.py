...
class SegmentationTrainingControlState:
...
def read_segmentation_training_control_state(
    *,
    ...
    if not isinstance(raw_control, dict):
        return SegmentationTrainingControlState()
    return SegmentationTrainingControlState(
...
def clear_segmentation_manual_save_request(
    *,
    metadata: dict[str, object],
    control_metadata_key: str,
...
def build_segmentation_training_control_metadata(
    *,
    metadata: dict[str, object],
    control_metadata_key: str,
    flag: str,
