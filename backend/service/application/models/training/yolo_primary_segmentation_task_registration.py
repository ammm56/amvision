...
class YoloPrimarySegmentationTrainingResultLike(Protocol):
    """描述登记 segmentation 训练输出所需的执行结果字段。"""

    labels: tuple[str, ...]


def resolve_yolo_primary_segmentation_implementation_mode(model_type: str) -> str:
...
def register_yolo_primary_segmentation_training_output_model_version(
    *,
    ...
    model_type: str,
    execution_result: YoloPrimarySegmentationTrainingResultLike,
