...
class YoloPrimaryClassificationTrainingControlState:
...
def read_yolo_primary_classification_training_control_state(
    *,
    ...
    if not isinstance(raw_control, dict):
        return YoloPrimaryClassificationTrainingControlState()
    return YoloPrimaryClassificationTrainingControlState(
...
def clear_yolo_primary_classification_manual_save_request(
    *,
    metadata: dict[str, object],
    control_metadata_key: str,
...
def build_yolo_primary_classification_training_control_metadata(
    *,
    metadata: dict[str, object],
    control_metadata_key: str,
    flag: str,
