...
class YoloTaskClassificationTrainingRequestPayload(Protocol):
...
def build_yolo_task_classification_training_task_spec(
    *,
    request: YoloTaskClassificationTrainingRequestPayload,
...
def build_yolo_task_classification_training_create_task_metadata(
    *,
    request: YoloTaskClassificationTrainingRequestPayload,
    dataset_export: DatasetExport,
    model_type: str,
...
def build_yolo_task_classification_training_queue_payload(
    *,
    task_id: str,
    task_kind: str,
    task_spec: dict[str, object],
...
def read_yolo_task_classification_training_payload(
