...
class SegmentationTrainingRequestPayload(Protocol):
...
def build_segmentation_training_task_spec(
    *,
    request: SegmentationTrainingRequestPayload,
...
def build_segmentation_training_create_task_metadata(
    *,
    request: SegmentationTrainingRequestPayload,
    dataset_export: DatasetExport,
    model_type: str,
...
def build_segmentation_training_queue_payload(
    *,
    task_id: str,
    task_kind: str,
    task_spec: dict[str, object],
...
def read_segmentation_training_payload(
