...
class YoloV8ClassificationTrainingControlState:
...
def read_yolov8_classification_training_control_state(
    *,
    ...
    if not isinstance(raw_control, dict):
        return YoloV8ClassificationTrainingControlState()
    return YoloV8ClassificationTrainingControlState(
...
def clear_yolov8_classification_manual_save_request(
    *,
    metadata: dict[str, object],
    control_metadata_key: str,
...
def build_yolov8_classification_training_control_metadata(
    *,
    metadata: dict[str, object],
    control_metadata_key: str,
    flag: str,
