...
class Yolo26ObbTaskRequestPayload(Protocol):
    """描述构建 YOLO26 OBB task_spec 所需的请求字段。"""
...
def build_yolo26_obb_task_spec(
    *,
    request: Yolo26ObbTaskRequestPayload,
...
def build_yolo26_obb_create_task_metadata(
    *,
    request: Yolo26ObbTaskRequestPayload,
    dataset_export: DatasetExport,
    model_type: str,
...
def build_yolo26_obb_queue_payload(
    *,
    task_id: str,
    task_kind: str,
    task_spec: dict[str, object],
...
def read_yolo26_obb_task_payload(task_record: TaskRecord) -> dict[str, object]:
    """从 TaskRecord 中恢复 YOLO26 OBB 训练负载。"""
