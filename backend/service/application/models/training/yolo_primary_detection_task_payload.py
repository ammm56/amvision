"""YOLO 主线 detection 训练任务 payload 组装工具。"""
...
def build_yolo_primary_detection_create_task_metadata(
    *,
...
def build_yolo_primary_detection_queue_metadata(
    *,
    project_id: str,
    dataset_export: DatasetExport,
    model_name: str,
...
def build_yolo_primary_detection_task_spec_payload(
    *,
    task_spec: Any,
    model_name: str,
) -> dict[str, object]:
...
def build_yolo_primary_detection_request_kwargs_from_task_record(
...
def build_yolo_primary_detection_existing_result_kwargs(
    task_record: TaskRecord,
...
def build_yolo_primary_detection_partial_result_kwargs(
    *,
    task_id: str,
    dataset_export: DatasetExport,
...
def build_yolo_primary_detection_output_files_summary(
    output_files: DetectionTrainingOutputFiles,
) -> dict[str, object]:
...
def serialize_yolo_primary_detection_training_task_result(
    task_result: Any,
) -> dict[str, object]:
