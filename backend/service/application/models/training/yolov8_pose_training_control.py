...
class YoloV8PoseTrainingControlState:
    """描述 pose 训练控制状态快照。"""
...
def read_yolov8_pose_training_control_state(
    *,
    ...
    if not isinstance(raw_control, dict):
        return YoloV8PoseTrainingControlState()
    return YoloV8PoseTrainingControlState(
...
def clear_yolov8_pose_manual_save_request(
    *,
    metadata: dict[str, object],
    control_metadata_key: str,
...
def build_yolov8_pose_training_control_metadata(
    *,
    metadata: dict[str, object],
    control_metadata_key: str,
    flag: str,
