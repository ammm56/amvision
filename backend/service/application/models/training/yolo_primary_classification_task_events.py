...
def build_yolo_primary_classification_training_queue_failed_event(
    *,
    task_id: str,
    error_message: str,
    finished_at: str,
...
def build_yolo_primary_classification_training_queued_event(
    *,
    task_id: str,
    queue_name: str,
    queue_task_id: str,
...
def build_yolo_primary_classification_training_started_event(
    *,
    task_id: str,
    started_at: str,
    model_type: str,
...
def build_yolo_primary_classification_training_cancelled_event(
    *,
    task_id: str,
    finished_at: str,
...
def build_yolo_primary_classification_training_paused_event(
    *,
    task_id: str,
    result: dict[str, object],
    control_metadata_key: str,
...
def build_yolo_primary_classification_training_failed_event(
    *,
    task_id: str,
    finished_at: str,
    error_message: str,
...
def build_yolo_primary_classification_training_succeeded_event(
    *,
    task_id: str,
    finished_at: str,
    result: dict[str, object],
