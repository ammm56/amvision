"""YOLO11 classification 训练任务负载工具。"""
...
class Yolo11ClassificationTaskRequestPayload(Protocol):
    """描述构建 YOLO11 classification task_spec 所需的请求字段。"""
...
def build_yolo11_classification_task_spec(
    *,
    request: Yolo11ClassificationTaskRequestPayload,
...
def build_yolo11_classification_create_task_metadata(
    *,
    request: Yolo11ClassificationTaskRequestPayload,
    dataset_export: DatasetExport,
    model_type: str,
...
def build_yolo11_classification_queue_payload(
    *,
    task_id: str,
    task_kind: str,
    task_spec: dict[str, object],
...
def read_yolo11_classification_task_payload(
    task_record: TaskRecord,
) -> dict[str, object]:
    """从 TaskRecord 中恢复 YOLO11 classification 训练负载。"""
