"""YOLO 主线 classification 训练数据集解析工具。"""
...
def resolve_yolo_primary_classification_training_dataset_export(
    *,
    ...
    """根据训练请求解析可用于 classification 训练的 DatasetExport。
    ...
    if dataset_export_id is not None:
        export_by_id = _get_yolo_primary_classification_dataset_export(
    ...
    if dataset_export_manifest_key is not None:
        export_by_manifest = _get_yolo_primary_classification_dataset_export_by_manifest(
            session_factory=session_factory,
...
def _get_yolo_primary_classification_dataset_export(
    *,
    session_factory: SessionFactory,
...
def _get_yolo_primary_classification_dataset_export_by_manifest(
    *,
    session_factory: SessionFactory,
