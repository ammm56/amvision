...
class Yolo11ObbTaskRequestPayload(Protocol):
    """描述构建 YOLO11 OBB task_spec 所需的请求字段。"""
...
def build_yolo11_obb_task_spec(
    *,
    request: Yolo11ObbTaskRequestPayload,
...
def build_yolo11_obb_create_task_metadata(
    *,
    request: Yolo11ObbTaskRequestPayload,
    dataset_export: DatasetExport,
    model_type: str,
...
def build_yolo11_obb_queue_payload(
    *,
    task_id: str,
    task_kind: str,
    task_spec: dict[str, object],
...
def read_yolo11_obb_task_payload(task_record: TaskRecord) -> dict[str, object]:
    """从 TaskRecord 中恢复 YOLO11 OBB 训练负载。"""
