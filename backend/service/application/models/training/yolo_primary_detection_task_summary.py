"""YOLO 主线 detection 训练 summary 组装工具。"""
...
def build_yolo_primary_detection_training_summary(
    *,
    task_id: str,
    request: Any,
    ...
    summary["training_config"]["resolved_extra_options"] = (
        build_yolo_primary_detection_resolved_extra_options_payload(
...
def build_yolo_primary_detection_resolved_extra_options_payload(
    *,
