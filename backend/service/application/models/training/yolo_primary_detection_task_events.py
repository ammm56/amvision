...
def build_yolo_primary_detection_training_queue_failed_event(
    *,
    task_id: str,
    model_type: str,
    error_message: str,
...
def build_yolo_primary_detection_training_queued_event(
    *,
    task_id: str,
    model_type: str,
    queue_name: str,
...
def build_yolo_primary_detection_training_control_event(
    *,
    task_id: str,
    model_type: str,
    action: str,
...
def build_yolo_primary_detection_training_cancelled_event(
    *,
    task_id: str,
    model_type: str,
    finished_at: str,
...
def build_yolo_primary_detection_training_resume_requested_event(
    *,
    task_id: str,
    model_type: str,
    control_metadata_key: str,
...
def build_yolo_primary_detection_training_resume_reverted_event(
    *,
    task_id: str,
    model_type: str,
    control_metadata_key: str,
...
def build_yolo_primary_detection_training_started_event(
    *,
    task_id: str,
    model_type: str,
    started_at: str,
...
def build_yolo_primary_detection_training_completed_event(
    *,
    task_id: str,
    model_type: str,
    finished_at: str,
...
def build_yolo_primary_detection_training_paused_event(
    *,
    task_id: str,
    model_type: str,
    finished_at: str,
...
def build_yolo_primary_detection_training_terminated_result_event(
    *,
    task_id: str,
    model_type: str,
    finished_at: str,
...
def build_yolo_primary_detection_training_failed_event(
    *,
    task_id: str,
    model_type: str,
    finished_at: str,
...
def build_yolo_primary_detection_training_batch_progress_event(
    *,
    task_id: str,
    model_type: str,
    attempt_no: int,
...
def build_yolo_primary_detection_training_epoch_progress_event(
    *,
    task_id: str,
    model_type: str,
    attempt_no: int,
...
def build_yolo_primary_detection_training_checkpoint_saved_event(
    *,
    task_id: str,
    model_type: str,
    control_metadata_key: str,
...
def _build_output_file_result(output_files: DetectionTrainingOutputFiles) -> dict[str, object]:
