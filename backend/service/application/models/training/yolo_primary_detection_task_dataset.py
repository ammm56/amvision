...
class YoloPrimaryDetectionDatasetExportRequest(Protocol):
...
def resolve_yolo_primary_detection_training_dataset_export(
    *,
    session_factory: SessionFactory,
    request: YoloPrimaryDetectionDatasetExportRequest,
    model_name: str,
    model_label: str,
) -> DatasetExport:
    ...
    if request.dataset_export_id is not None:
        export_by_id = _get_yolo_primary_detection_dataset_export(
    ...
    if request.dataset_export_manifest_key is not None:
        export_by_manifest = _get_yolo_primary_detection_dataset_export_by_manifest(
            session_factory=session_factory,
...
def _get_yolo_primary_detection_dataset_export(
    *,
    session_factory: SessionFactory,
...
def _get_yolo_primary_detection_dataset_export_by_manifest(
    *,
    session_factory: SessionFactory,
