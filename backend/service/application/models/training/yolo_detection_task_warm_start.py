"""YOLO detection warm start 解析工具。"""
...
class YoloDetectionWarmStartReference:
...
def resolve_yolo_detection_warm_start_reference(
    *,
...
) -> YoloDetectionWarmStartReference | None:
    ...
    return YoloDetectionWarmStartReference(
...
def build_yolo_detection_warm_start_source_summary(
    warm_start_reference: YoloDetectionWarmStartReference,
) -> dict[str, object]:
