...
def build_yolo_primary_pose_training_started_event(
    *,
    task_id: str,
    started_at: str,
    model_type: str,
...
def build_yolo_primary_pose_training_cancelled_event(
    *,
    task_id: str,
    finished_at: str,
...
def build_yolo_primary_pose_training_paused_event(
    *,
    task_id: str,
    result: dict[str, object],
    control_metadata_key: str,
...
def build_yolo_primary_pose_training_failed_event(
    *,
    task_id: str,
    finished_at: str,
    error_message: str,
...
def build_yolo_primary_pose_training_succeeded_event(
    *,
    task_id: str,
    finished_at: str,
    result: dict[str, object],
