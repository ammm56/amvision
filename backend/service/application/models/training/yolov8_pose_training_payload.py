...
class YoloV8PoseTrainingRequestPayload(Protocol):
...
def build_yolov8_pose_training_task_spec(
    *,
    request: YoloV8PoseTrainingRequestPayload,
...
def build_yolov8_pose_training_create_task_metadata(
    *,
    request: YoloV8PoseTrainingRequestPayload,
    dataset_export: DatasetExport,
    model_type: str,
...
def build_yolov8_pose_training_queue_payload(
    *,
    task_id: str,
    task_kind: str,
    task_spec: dict[str, object],
...
def read_yolov8_pose_training_payload(task_record: TaskRecord) -> dict[str, object]:
