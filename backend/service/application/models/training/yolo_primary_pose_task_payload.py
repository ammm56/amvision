...
class YoloPrimaryPoseTaskRequestPayload(Protocol):
...
def build_yolo_primary_pose_task_spec(
    *,
    request: YoloPrimaryPoseTaskRequestPayload,
...
def build_yolo_primary_pose_create_task_metadata(
    *,
    request: YoloPrimaryPoseTaskRequestPayload,
    dataset_export: DatasetExport,
    model_type: str,
...
def build_yolo_primary_pose_queue_payload(
    *,
    task_id: str,
    task_kind: str,
    task_spec: dict[str, object],
...
def read_yolo_primary_pose_task_payload(task_record: TaskRecord) -> dict[str, object]:
