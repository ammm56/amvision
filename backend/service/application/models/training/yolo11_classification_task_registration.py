"""YOLO11 classification 训练输出登记工具。"""
...
class Yolo11ClassificationTrainingResultLike(Protocol):
    """描述登记 YOLO11 classification 训练输出所需的执行结果字段。"""

    labels: tuple[str, ...]


def resolve_yolo11_classification_implementation_mode() -> str:
    """返回 YOLO11 classification 训练实现标记。"""

    return YOLO11_CLASSIFICATION_IMPLEMENTATION_MODE


def register_yolo11_classification_training_output_model_version(
    *,
    session_factory: SessionFactory,
    task_record: TaskRecord,
    dataset_export: DatasetExport,
    payload: dict[str, object],
    execution_result: Yolo11ClassificationTrainingResultLike,
    ...
    return model_service.register_training_output(
        Yolo11TrainingOutputRegistration(
            ...
            metadata={
                ...
                "implementation_mode": resolve_yolo11_classification_implementation_mode(),
            },
        )
    )
