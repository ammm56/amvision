...
class YoloTaskObbTrainingControlState:
    """描述 OBB 训练控制状态快照。"""
...
def read_yolo_task_obb_training_control_state(
    *,
    ...
    if not isinstance(raw_control, dict):
        return YoloTaskObbTrainingControlState()
    return YoloTaskObbTrainingControlState(
...
def clear_yolo_task_obb_manual_save_request(
    *,
    metadata: dict[str, object],
    control_metadata_key: str,
...
def build_yolo_task_obb_training_control_metadata(
    *,
    metadata: dict[str, object],
    control_metadata_key: str,
    flag: str,
