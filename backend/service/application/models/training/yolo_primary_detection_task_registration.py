...
def register_yolo_primary_detection_training_output_model_version(
    *,
    ...
    return model_service.register_training_output(
        output_registration_cls(
            ...
            checkpoint_file_id=build_training_output_file_id(task_record.task_id, "checkpoint"),
            ...
            metrics_file_id=build_training_output_file_id(task_record.task_id, "metrics"),
