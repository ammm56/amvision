...
def resolve_yolov8_pose_training_dataset_export(
    *,
    ...
    if dataset_export_id is not None:
        export_by_id = _get_yolov8_pose_dataset_export(
    ...
    if dataset_export_manifest_key is not None:
        export_by_manifest = _get_yolov8_pose_dataset_export_by_manifest(
            session_factory=session_factory,
...
def _get_yolov8_pose_dataset_export(
    *,
    session_factory: SessionFactory,
...
def _get_yolov8_pose_dataset_export_by_manifest(
    *,
    session_factory: SessionFactory,
