...
class Yolo26SegmentationTrainingResultLike(Protocol):
    """描述登记 YOLO26 segmentation 训练输出所需的执行结果字段。"""

    labels: tuple[str, ...]


def resolve_yolo26_segmentation_implementation_mode() -> str:
    """返回 YOLO26 segmentation 训练实现标记。"""

    return YOLO26_SEGMENTATION_IMPLEMENTATION_MODE


def register_yolo26_segmentation_training_output_model_version(
    *,
    session_factory: SessionFactory,
    task_record: TaskRecord,
    dataset_export: DatasetExport,
    payload: dict[str, object],
    execution_result: Yolo26SegmentationTrainingResultLike,
    ...
    return model_service.register_training_output(
        Yolo26TrainingOutputRegistration(
            ...
            metadata={
                ...
                "implementation_mode": resolve_yolo26_segmentation_implementation_mode(),
            },
        )
    )
