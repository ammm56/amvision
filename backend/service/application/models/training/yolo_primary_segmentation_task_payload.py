...
class YoloPrimarySegmentationTaskRequestPayload(Protocol):
...
def build_yolo_primary_segmentation_task_spec(
    *,
    request: YoloPrimarySegmentationTaskRequestPayload,
...
def build_yolo_primary_segmentation_create_task_metadata(
    *,
    request: YoloPrimarySegmentationTaskRequestPayload,
    dataset_export: DatasetExport,
    model_type: str,
...
def build_yolo_primary_segmentation_queue_payload(
    *,
    task_id: str,
    task_kind: str,
    task_spec: dict[str, object],
...
def read_yolo_primary_segmentation_task_payload(
