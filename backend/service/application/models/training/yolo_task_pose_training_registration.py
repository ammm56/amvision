...
from backend.service.application.models.training.yolo_task_pose_training import (
    YOLO_TASK_POSE_IMPLEMENTATION_MODE,
...
YOLO_TASK_POSE_MODEL_SERVICE_MAP: dict[str, tuple[type, type]] = {
...
def resolve_yolo_task_pose_implementation_mode(model_type: str) -> str:
    """按 model_type 返回 pose 训练实现模式。"""

    return YOLO_TASK_POSE_IMPLEMENTATION_MODE


def register_yolo_task_pose_training_output_model_version(
    *,
    ...
    service_cls, registration_cls = YOLO_TASK_POSE_MODEL_SERVICE_MAP[model_type]
    ...
    return model_service.register_training_output(
        registration_cls(
            ...
            metadata={
                ...
                "implementation_mode": resolve_yolo_task_pose_implementation_mode(
                    model_type
                ),
            },
        )
