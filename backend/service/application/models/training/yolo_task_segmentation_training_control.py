...
class YoloTaskSegmentationTrainingControlState:
...
def read_yolo_task_segmentation_training_control_state(
    *,
    ...
    if not isinstance(raw_control, dict):
        return YoloTaskSegmentationTrainingControlState()
    return YoloTaskSegmentationTrainingControlState(
...
def clear_yolo_task_segmentation_manual_save_request(
    *,
    metadata: dict[str, object],
    control_metadata_key: str,
...
def build_yolo_task_segmentation_training_control_metadata(
    *,
    metadata: dict[str, object],
    control_metadata_key: str,
    flag: str,
