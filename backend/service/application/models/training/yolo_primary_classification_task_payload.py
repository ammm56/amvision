...
class YoloPrimaryClassificationTaskRequestPayload(Protocol):
...
def build_yolo_primary_classification_task_spec(
    *,
    request: YoloPrimaryClassificationTaskRequestPayload,
...
def build_yolo_primary_classification_create_task_metadata(
    *,
    request: YoloPrimaryClassificationTaskRequestPayload,
    dataset_export: DatasetExport,
    model_type: str,
...
def build_yolo_primary_classification_queue_payload(
    *,
    task_id: str,
    task_kind: str,
    task_spec: dict[str, object],
...
def read_yolo_primary_classification_task_payload(
