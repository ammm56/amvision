...
class YoloTaskPoseTrainingRequestPayload(Protocol):
    """描述构建 pose 训练 task_spec 所需的请求字段。"""
...
def build_yolo_task_pose_training_task_spec(
    *,
    request: YoloTaskPoseTrainingRequestPayload,
...
def build_yolo_task_pose_training_create_task_metadata(
    *,
    request: YoloTaskPoseTrainingRequestPayload,
    dataset_export: DatasetExport,
    model_type: str,
...
def build_yolo_task_pose_training_queue_payload(
    *,
    task_id: str,
    task_kind: str,
    task_spec: dict[str, object],
...
def read_yolo_task_pose_training_payload(task_record: TaskRecord) -> dict[str, object]:
    """从 TaskRecord 中恢复 pose 训练负载。"""
