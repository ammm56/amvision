...
YOLO26_OBB_DEFAULT_LR = 1e-3
YOLO26_OBB_DEFAULT_WEIGHT_DECAY = 1e-4
YOLO26_OBB_DEFAULT_MIN_LR_RATIO = 0.01
YOLO26_OBB_DEFAULT_EVAL_CONF = 0.01
YOLO26_OBB_DEFAULT_EVAL_NMS = 0.65
...
def run_yolo26_obb_training(
    ...
    eval_conf = float(
        extra.get("eval_confidence_threshold", YOLO26_OBB_DEFAULT_EVAL_CONF)
    )
    eval_nms = float(extra.get("eval_nms_threshold", YOLO26_OBB_DEFAULT_EVAL_NMS))
