"""YOLO26 OBB target 编码和旋转框几何辅助函数。"""
...
def yolo26_anchor_in_rotated_box(
    *,
    torch_module: Any,
    anchor_points: Any,
    corners: Any,
) -> Any:
    """判断 anchor 是否位于 YOLO26 旋转框内部。"""
...
def yolo26_decode_distances_to_rboxes(
    *,
    torch_module: Any,
    pred_dist: Any,
    pred_angle: Any,
    ...
    """把 YOLO26 OBB distance 与 angle 解码为 grid 坐标系 xywhr。"""
...
def yolo26_rbox_to_distances(
    *,
    ...
    """把像素坐标系 YOLO26 GT 旋转框编码为 DFL 使用的 ltrb 距离。"""
...
def yolo26_xywhr_to_corners(
    *,
    torch_module: Any,
    rboxes: Any,
) -> Any:
    """把 YOLO26 xywhr 旋转框转换为四角点。"""
...
def yolo26_xywhr_to_xyxy(torch_module: Any, rboxes: Any) -> Any:
    """把 YOLO26 xywhr 旋转框转成轴对齐 xyxy 包围盒。"""
