...
def evaluate_yolo26_classification_samples(
    *,
    model: Any,
    samples: list[Any],
    labels: tuple[str, ...],
    ...
    """对验证样本执行 YOLO26 classification 训练期评估。"""
    ...
    with imports.torch.no_grad():
        for cpu_batch in validation_dataloader:
            ...
            _, probabilities = normalize_yolo26_classification_training_outputs(
                outputs=outputs,
            )
...
__all__ = ["evaluate_yolo26_classification_samples"]
