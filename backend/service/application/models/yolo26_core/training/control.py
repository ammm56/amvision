...
class Yolo26DetectionEpochControlDecision:
    """描述 YOLO26 detection 在 epoch 边界需要执行的控制动作。"""
...
def resolve_yolo26_detection_epoch_control(
    *,
    ...
    """把应用层控制请求转换成 YOLO26 detection 训练循环动作。"""
    ...
    return Yolo26DetectionEpochControlDecision(
