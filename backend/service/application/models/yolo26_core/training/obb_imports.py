...
class Yolo26ObbTrainingImports:
    """描述 YOLO26 OBB 训练需要的本地模块。"""
...
def require_yolo26_obb_training_imports() -> Yolo26ObbTrainingImports:
    """导入 YOLO26 OBB 训练依赖。"""
    ...
    return Yolo26ObbTrainingImports(cv2=cv2, np=np, torch=torch)


def resolve_yolo26_obb_training_device(
    *,
    torch_module: Any,
