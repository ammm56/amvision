"""YOLO26 detection 训练 savepoint 组装规则。"""
...
class Yolo26DetectionTrainingSavepointPayload:
    """描述 YOLO26 detection 在 epoch 边界需要交给应用层保存的数据。"""
...
def build_yolo26_detection_training_savepoint_payload(
    *,
    epoch: int,
    latest_checkpoint_bytes: bytes,
