"""YOLO26 pose DatasetExport manifest 解析。"""
...
YOLO26_POSE_DEFAULT_KEYPOINT_SHAPE = (17, 3)


@dataclass(frozen=True)
class Yolo26PoseTrainingAnnotation:
    """描述一张 YOLO26 pose 训练图片及其标注。"""
...
@dataclass(frozen=True)
class Yolo26PoseTrainingManifest:
    """描述 YOLO26 pose 训练 manifest 解析结果。"""
...
def load_yolo26_pose_training_manifest(
    *,
    ...
    keypoint_shape = resolve_yolo26_pose_keypoint_shape(
        manifest=manifest_payload,
...
def resolve_yolo26_pose_keypoint_shape(
    *,
    ...
    return YOLO26_POSE_DEFAULT_KEYPOINT_SHAPE


def read_yolo26_pose_keypoint_shape(
    manifest: dict[str, object],
) -> tuple[int, int] | None:
    ...
    *,
    ...
    if format_id == YOLO_POSE_DATASET_FORMAT:
        ...
        return build_coco_payload_from_yolo_pose_split(
            ...
            pose_shape=read_yolo26_pose_keypoint_shape(manifest),
        )
...
def _build_pose_split_records(
    *,
    ...
    """把 COCO payload 转成 YOLO26 pose 训练样本。"""
    ...
    records: list[Yolo26PoseTrainingAnnotation] = []
...
def _remap_pose_categories(
    annotations: list[Yolo26PoseTrainingAnnotation],
...
__all__ = [
    "YOLO26_POSE_DEFAULT_KEYPOINT_SHAPE",
    "Yolo26PoseTrainingAnnotation",
    "Yolo26PoseTrainingManifest",
    "load_yolo26_pose_training_manifest",
    "read_yolo26_pose_keypoint_shape",
