...
def _prepare_yolo26_detection_sample_without_augmentation(
    *,
    ...
    return _letterbox_yolo26_detection_sample_to_size(
        imports=imports,
        image=image,
...
def _prepare_yolo26_detection_sample_with_augmentation(
    *,
    ...
    """按参考顺序构造启用增强后的 YOLO26 detection 训练样本。"""

    image, boxes_xyxy, category_indexes = _prepare_yolo26_detection_pre_transform(
        imports=imports,
    ...
    if (
        ...
        mixup_image, mixup_boxes, mixup_categories = (
            _prepare_yolo26_detection_pre_transform(
                imports=imports,
...
def _prepare_yolo26_detection_pre_transform(
    *,
    imports: Any,
    primary_sample: Any,
    available_samples: Sequence[Any],
    ...
    return _apply_yolo26_detection_affine(
        imports=imports,
        image=image,
        boxes_xyxy=boxes_xyxy,
        category_indexes=category_indexes,
...
def _letterbox_yolo26_detection_sample_to_size(
    *,
    imports: Any,
    image: Any,
