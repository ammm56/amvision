...
class Yolo26SegmentationTrainingBatch:
    ...
    def pin_memory(self) -> "Yolo26SegmentationTrainingBatch":
...
def _prepare_yolo26_segmentation_mixup_sample(
    *,
    ...
    if prepared is None:
        return None
    image, target = prepared
    return _apply_yolo26_segmentation_random_affine(
        imports=imports,
        image=image,
        target=target,
        target_width=target_width,
...
def _build_yolo26_segmentation_mosaic_sample(
    *,
    ...
    for placement in placements:
        ...
        placed_target = _build_yolo26_segmentation_sample_targets(
            sample=sample,
