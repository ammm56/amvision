...
def compute_yolo26_detection_loss(
    *,
    torch_module: Any,
    detect_head: Any,
    ...
    """按 YOLO26 detection 规则计算分类、框回归和 DFL 损失。"""
    ...
    for batch_index, target in enumerate(batch_targets):
        ...
        if target.boxes_xyxy:
            loss_state = _compute_yolo26_image_detection_loss(
                torch_module=torch_module,
...
def yolo26_distribution_focal_loss(
    *,
    torch_module: Any,
    logits: Any,
    target: Any,
