"""YOLOv8 classification PyTorch runtime session。"""
...
class PyTorchYoloV8ClassificationRuntimeSession:
    ...
    def __init__(
        ...
        *,
        ...
        """初始化 PyTorch YOLOv8 classification 会话。"""
    ...
    def load(
        ...
        *,
        ...
        """加载一套 PyTorch YOLOv8 classification 会话。"""

        if runtime_target.runtime_backend != "pytorch":
            raise InvalidRequestError(
                "当前 YOLOv8 classification predictor 仅支持 pytorch runtime_backend",
        ...
        imports = require_yolov8_classification_pytorch_imports()
        ...
        device_name = resolve_yolov8_classification_torch_device_name(
            torch_module=imports.torch,
    ...
    def predict(
        ...
        """执行一次 PyTorch YOLOv8 classification 预测。"""
        ...
        if callable(inference_mode):
            ...
            with self.imports.torch.no_grad():
                outputs = self.model(input_tensor)
        infer_ms = measure_yolov8_classification_stage_elapsed_ms(
            imports=self.imports,
            device_name=self.device_name,
        ...
        postprocess_ms = measure_yolov8_classification_stage_elapsed_ms(
            imports=self.imports,
            device_name=self.device_name,
...
__all__ = ["PyTorchYoloV8ClassificationRuntimeSession"]
