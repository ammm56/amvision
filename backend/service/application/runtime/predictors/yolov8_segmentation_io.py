"""YOLOv8 segmentation runtime 输入图片和预处理工具。"""
...
def load_yolov8_segmentation_prediction_image(
    *,
    cv2_module: Any,
    np_module: Any,
    ...
    """按 storage 或 memory 模式加载本次 segmentation 推理输入图片。"""
...
def preprocess_yolov8_segmentation_image(
    *,
    cv2_module: Any,
    np_module: Any,
    image: Any,
    ...
    """按 YOLOv8 segmentation 推理规则构造输入张量。"""

    return preprocess_yolov8_detection_image(
        cv2_module=cv2_module,
        np_module=np_module,
        image=image,
