"""YOLO26 classification ONNXRuntime runtime session。"""
...
class OnnxRuntimeYolo26ClassificationRuntimeSession:
    ...
    def __init__(
        ...
        *,
        ...
        """初始化 ONNXRuntime YOLO26 classification 会话。"""
    ...
    def load(
        ...
        *,
        ...
        """加载一套 ONNXRuntime YOLO26 classification 会话。"""

        if runtime_target.runtime_backend != "onnxruntime":
            raise InvalidRequestError(
                "当前 YOLO26 classification predictor 仅支持 onnxruntime runtime_backend",
        ...
        if runtime_target.runtime_precision != "fp32":
            raise InvalidRequestError(
                "当前 YOLO26 classification onnxruntime session 仅支持 fp32 precision",
                details={"runtime_precision": runtime_target.runtime_precision},
            )

        imports = require_yolo26_classification_inference_imports()
        onnxruntime_module = import_yolo26_classification_onnxruntime_module()
        providers = resolve_yolo26_classification_onnxruntime_providers(
    ...
    def predict(
        ...
        """执行一次 ONNXRuntime YOLO26 classification 预测。"""
...
__all__ = ["OnnxRuntimeYolo26ClassificationRuntimeSession"]
