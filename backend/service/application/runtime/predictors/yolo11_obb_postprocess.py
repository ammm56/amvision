...
def build_yolo11_obb_runtime_instances(
    *,
    np_module: Any,
    ...
    """把 YOLO11 OBB 输出数组转换成平台实例记录。"""

    core_instances = build_yolo11_obb_inference_instances(
        np_module=np_module,
        ...
        nms_threshold=DEFAULT_YOLO11_OBB_NMS_THRESHOLD,
...
__all__ = ["build_yolo11_obb_runtime_instances"]
