"""YOLOv8 detection ONNXRuntime runtime session。"""
...
class OnnxRuntimeYoloV8RuntimeSession:
    """已经加载完成并可重复推理的 ONNXRuntime YOLOv8 detection 会话。"""
    ...
    def __init__(
        ...
        *,
        ...
        """初始化 ONNXRuntime YOLOv8 detection 会话。"""
    ...
    def load(
        ...
        *,
        ...
        """加载一套 ONNXRuntime YOLOv8 detection 会话。"""

        if runtime_target.runtime_backend != "onnxruntime":
            raise InvalidRequestError(
                "当前 YOLOv8 detection predictor 仅支持 onnxruntime runtime_backend",
                details={"runtime_backend": runtime_target.runtime_backend},
            )

        imports = require_yolov8_detection_inference_imports()
        onnxruntime_module = import_yolov8_detection_onnxruntime_module()
        providers = resolve_yolov8_detection_onnxruntime_providers(
    ...
    def predict(
        ...
        """执行一次 ONNXRuntime YOLOv8 detection 预测。"""
        ...
        prediction_array = normalize_yolov8_detection_onnxruntime_outputs(
            outputs=outputs,
...
__all__ = ["OnnxRuntimeYoloV8RuntimeSession"]
