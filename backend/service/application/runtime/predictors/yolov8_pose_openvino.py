...
class OpenVINOYoloV8PoseRuntimeSession:
    ...
    def load(
        ...
        *,
        ...
        return cls(
            ...
            input_name=resolve_yolov8_pose_openvino_port_name(input_port, fallback="images"),
            output_name=resolve_yolov8_pose_openvino_port_name(output_port, fallback="predictions"),
    ...
    def predict(self, request: YoloV8PosePredictionRequest) -> YoloV8PosePredictionExecutionResult:
        ...
        if raw_output is None:
            raise ServiceConfigurationError("OpenVINO pose session 缺少 predictions 输出")
        ...
        return YoloV8PosePredictionExecutionResult(
            ...
            runtime_session_info=YoloV8PoseRuntimeSessionInfo(
                ...
                input_spec=YoloV8PoseRuntimeTensorSpec(
                    ...
                    dtype=resolve_yolov8_pose_openvino_port_dtype(self.input_port, fallback="float32"),
                ),
                output_specs=(
                    YoloV8PoseRuntimeTensorSpec(
