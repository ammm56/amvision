...
def serialize_yolox_detection(detection: Any) -> dict[str, object]:
...
def serialize_yolox_runtime_session_info(session_info: Any) -> dict[str, object]:
