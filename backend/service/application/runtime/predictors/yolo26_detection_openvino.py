"""YOLO26 detection OpenVINO runtime session。"""
...
class OpenVINOYolo26RuntimeSession:
    ...
    def __init__(
        ...
        *,
        ...
        """初始化 OpenVINO YOLO26 detection 会话。"""
    ...
    def load(
        ...
        *,
        ...
        """加载一套 OpenVINO YOLO26 detection 会话。"""

        if runtime_target.runtime_backend != "openvino":
            raise InvalidRequestError(
                "当前 YOLO26 detection predictor 仅支持 openvino runtime_backend",
    ...
    def predict(
        ...
        """执行一次 OpenVINO YOLO26 detection 预测。"""
...
__all__ = ["OpenVINOYolo26RuntimeSession"]
