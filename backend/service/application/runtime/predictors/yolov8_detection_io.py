"""YOLOv8 detection runtime 输入图片和预处理工具。"""
...
from backend.service.application.runtime.runtime_target import resolve_local_file_path
from backend.service.infrastructure.object_store.local_dataset_storage import LocalDatasetStorage


def load_yolov8_detection_prediction_image(
    *,
    cv2_module: Any,
    np_module: Any,
...
def preprocess_yolov8_detection_image(
    *,
    cv2_module: Any,
    np_module: Any,
    image: Any,
