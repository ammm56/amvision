"""YOLOv8 OBB OpenVINO runtime session。"""
...
class OpenVINOYoloV8ObbRuntimeSession:
    """已经加载完成并可重复推理的 OpenVINO YOLOv8 OBB 会话。"""
        ...
        *,
        ...
        if runtime_target.runtime_backend != "openvino":
            raise InvalidRequestError(
                "当前 YOLOv8 OBB predictor 仅支持 openvino runtime_backend",
        ...
        openvino_module = import_yolov8_obb_openvino_module()
        compiled_device_name = resolve_yolov8_obb_openvino_device_name(
            requested_device_name=runtime_target.device_name,
        )
        compile_properties = build_yolov8_obb_openvino_compile_properties(
        ...
        return cls(
            ...
            compiled_runtime_precision=resolve_yolov8_obb_openvino_compiled_runtime_precision(
                session=session,
...
__all__ = ["OpenVINOYoloV8ObbRuntimeSession"]
