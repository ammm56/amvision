"""YOLO26 segmentation OpenVINO runtime session。"""
...
class OpenVINOYolo26SegmentationRuntimeSession:
    ...
    def __init__(
        ...
        *,
        ...
        """初始化 OpenVINO YOLO26 segmentation 会话。"""
    ...
    def load(
        ...
        *,
        ...
        """加载一套 OpenVINO YOLO26 segmentation 会话。"""

        if runtime_target.runtime_backend != "openvino":
            raise InvalidRequestError(
                "当前 YOLO26 segmentation predictor 仅支持 openvino runtime_backend",
        ...
        openvino_module = import_yolo26_segmentation_openvino_module()
        compiled_device_name = resolve_yolo26_segmentation_openvino_device_name(
            requested_device_name=runtime_target.device_name,
        )
        compile_properties = build_yolo26_segmentation_openvino_compile_properties(
        ...
        prediction_name = resolve_yolo26_segmentation_openvino_port_name(
            prediction_port,
            fallback="predictions",
        )
        proto_name = resolve_yolo26_segmentation_openvino_port_name(
            proto_port,
            fallback="proto",
        )
        return cls(
            ...
            input_name=resolve_yolo26_segmentation_openvino_port_name(
            ...
            compiled_runtime_precision=resolve_yolo26_segmentation_openvino_compiled_runtime_precision(
                session=session,
    ...
    def predict(
        ...
        """执行一次 OpenVINO YOLO26 segmentation 预测。"""
        ...
        return Yolo26SegmentationPredictionExecutionResult(
            ...
            runtime_session_info=Yolo26SegmentationRuntimeSessionInfo(
                ...
                input_spec=Yolo26SegmentationRuntimeTensorSpec(
                    ...
                    dtype=resolve_yolo26_segmentation_openvino_port_dtype(
                        self.input_port,
                        fallback="float32",
                    ),
                ),
...
__all__ = ["OpenVINOYolo26SegmentationRuntimeSession"]
