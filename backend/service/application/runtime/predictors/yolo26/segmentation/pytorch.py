"""YOLO26 segmentation PyTorch runtime session。"""
...
class PyTorchYolo26SegmentationRuntimeSession:
    ...
    def __init__(
        ...
        *,
        ...
        """初始化 PyTorch YOLO26 segmentation 会话。"""
    ...
    def load(
        ...
        *,
        ...
        """加载一套 PyTorch YOLO26 segmentation 会话。"""

        if runtime_target.runtime_backend != "pytorch":
            raise InvalidRequestError(
                "当前 YOLO26 segmentation predictor 仅支持 pytorch runtime_backend",
        ...
        imports = require_yolo26_segmentation_pytorch_imports()
        ...
        device_name = resolve_yolo26_segmentation_torch_device_name(
            torch_module=imports.torch,
    ...
    def predict(
        ...
        """执行一次 PyTorch YOLO26 segmentation 预测。"""
        ...
        if callable(inference_mode):
            ...
            with self.imports.torch.no_grad():
                outputs = self.model(input_tensor)
        infer_ms = measure_yolo26_segmentation_stage_elapsed_ms(
            imports=self.imports,
            device_name=self.device_name,
        ...
        postprocess_ms = measure_yolo26_segmentation_stage_elapsed_ms(
            imports=self.imports,
            device_name=self.device_name,
...
__all__ = ["PyTorchYolo26SegmentationRuntimeSession"]
