...
from backend.service.application.runtime.predictors.yolo26.obb.buffer import (
...
from backend.service.application.runtime.predictors.yolo26.obb.timing import (
...
class TensorRTYolo26ObbRuntimeSession:
    ...
    def predict(
        ...
        input_tensor, letterbox_transform = preprocess_yolo26_obb_image(
            cv2_module=self.imports.cv2,
            np_module=self.imports.np,
            image=image,
        )
