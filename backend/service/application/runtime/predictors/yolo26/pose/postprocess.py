...
from backend.service.application.models.yolo26_core.cfg import get_yolo26_model_config
...
def infer_yolo26_pose_keypoint_shape(
    ...
    config = get_yolo26_model_config(task_type="pose")
...
def build_yolo26_pose_runtime_instances(
    *,
    np_module: Any,
    ...
    core_instances, core_kpt_shape = build_yolo26_pose_inference_instances(
        np_module=np_module,
