"""YOLO26 segmentation runtime 预览图渲染开关。"""
...
def render_yolo26_segmentation_preview_image_if_requested(
    *,
    cv2_module: Any,
    image: Any,
    instances: tuple[Any, ...],
    ...
    return render_yolo26_detection_preview_image(
...
__all__ = ["render_yolo26_segmentation_preview_image_if_requested"]
