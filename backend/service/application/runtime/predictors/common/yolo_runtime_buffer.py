"""YOLO TensorRT runtime buffer 通用工具。"""
...
def resolve_yolo_runtime_numpy_dtype(*, np_module: Any, dtype_name: str) -> Any:
...
def resolve_yolo_runtime_tensor_byte_size(
    *,
    np_module: Any,
    shape: tuple[int, ...],
    dtype: Any,
...
def build_yolo_runtime_numpy_array_from_host_pointer(
    *,
    np_module: Any,
    host_ptr: int,
    byte_size: int,
