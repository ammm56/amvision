"""YOLO11 pose runtime 输入图片和预处理工具。"""
...
load_yolo11_pose_prediction_image = load_yolov8_detection_prediction_image
preprocess_yolo11_pose_image = preprocess_yolov8_detection_image
