"""YOLOv8 segmentation runtime 预览图渲染开关。"""
...
def render_yolov8_segmentation_preview_image_if_requested(
    *,
    cv2_module: Any,
    image: Any,
    instances: tuple[Any, ...],
...
__all__ = ["render_yolov8_segmentation_preview_image_if_requested"]
