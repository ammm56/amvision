"""YOLO11 segmentation runtime 结果组装工具。"""
...
def build_yolo11_segmentation_runtime_instances(
    *,
    cv2_module: Any,
    np_module: Any,
...
) -> tuple[Yolo11SegmentationPredictionInstance, ...]:
    """把 YOLO11 segmentation 输出数组转换成平台实例记录。"""

    core_instances = build_yolo11_segmentation_inference_instances(
        ...
        nms_threshold=DEFAULT_YOLO11_SEGMENTATION_NMS_THRESHOLD,
...
__all__ = ["build_yolo11_segmentation_runtime_instances"]
