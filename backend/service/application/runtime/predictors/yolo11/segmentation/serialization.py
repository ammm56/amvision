"""YOLO11 segmentation runtime 响应序列化工具。"""
...
def serialize_yolo11_segmentation_instance(instance: Any) -> dict[str, object]:
    """把 YOLO11 segmentation 实例转换为 JSON 字典。"""
...
def serialize_yolo11_segmentation_runtime_session_info(
    session_info: Any,
) -> dict[str, object]:
    """把 YOLO11 segmentation runtime session info 转换为 JSON 字典。"""
...
__all__ = [
    "serialize_yolo11_segmentation_instance",
    "serialize_yolo11_segmentation_runtime_session_info",
]
