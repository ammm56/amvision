...
def infer_yolo11_pose_keypoint_shape(
    ...
    config = get_yolo11_model_config(task_type="pose")
...
def build_yolo11_pose_runtime_instances(
    *,
    np_module: Any,
    ...
    core_instances, core_kpt_shape = build_yolo11_pose_inference_instances(
        np_module=np_module,
