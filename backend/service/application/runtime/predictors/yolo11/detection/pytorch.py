"""YOLO11 detection PyTorch runtime session。"""
...
class Yolo11DetectionPytorchInferenceImports:
    """描述 YOLO11 detection PyTorch 推理依赖。"""
...
class PyTorchYolo11RuntimeSession:
    """已经加载完成并可重复推理的 PyTorch YOLO11 detection 会话。"""
    ...
    def __init__(
        ...
        *,
        ...
        imports: Yolo11DetectionPytorchInferenceImports,
        model: Any,
        device_name: str,
        runtime_precision: str,
    ) -> None:
        """初始化 PyTorch YOLO11 detection 会话。"""
    ...
    def load(
        ...
        *,
        ...
        """加载一套 PyTorch YOLO11 detection 会话。"""

        if runtime_target.runtime_backend != "pytorch":
            raise InvalidRequestError(
                "当前 YOLO11 detection predictor 仅支持 pytorch runtime_backend",
        ...
        imports = require_yolo11_detection_pytorch_imports()
    ...
    def predict(
        ...
        """执行一次 PyTorch YOLO11 detection 预测。"""
...
def require_yolo11_detection_pytorch_imports() -> (
    Yolo11DetectionPytorchInferenceImports
):
    """按需导入 YOLO11 detection PyTorch 推理依赖。"""
    ...
    return Yolo11DetectionPytorchInferenceImports(
...
__all__ = [
    "PyTorchYolo11RuntimeSession",
    "Yolo11DetectionPytorchInferenceImports",
    "require_yolo11_detection_pytorch_imports",
]
