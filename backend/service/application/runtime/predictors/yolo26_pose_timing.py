...
is_yolo26_pose_debugger_attached = is_yolov8_detection_debugger_attached
measure_yolo26_pose_cuda_event_elapsed_ms = (
    measure_yolov8_detection_cuda_event_elapsed_ms
)
measure_yolo26_pose_elapsed_ms = measure_yolov8_detection_elapsed_ms
measure_yolo26_pose_stage_elapsed_ms = measure_yolov8_detection_stage_elapsed_ms
