"""YOLO26 detection TensorRT runtime session。"""
...
class TensorRTYolo26RuntimeSession:
    ...
    def __init__(
        ...
        *,
        ...
        """初始化 TensorRT YOLO26 detection 会话。"""
    ...
    def load(
        ...
        *,
        ...
        """加载一套 TensorRT YOLO26 detection 会话。"""

        if runtime_target.runtime_backend != "tensorrt":
            raise InvalidRequestError(
                "当前 YOLO26 detection predictor 仅支持 tensorrt runtime_backend",
    ...
    def predict(
        ...
        """执行一次 TensorRT YOLO26 detection 预测。"""
...
__all__ = ["TensorRTYolo26RuntimeSession"]
