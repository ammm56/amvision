"""YOLOv8 segmentation ONNXRuntime runtime session。"""
...
class OnnxRuntimeYoloV8SegmentationRuntimeSession:
    ...
    def __init__(
        ...
        *,
        ...
        """初始化 ONNXRuntime YOLOv8 segmentation 会话。"""
    ...
    def load(
        ...
        *,
        ...
        """加载一套 ONNXRuntime YOLOv8 segmentation 会话。"""

        if runtime_target.runtime_backend != "onnxruntime":
            raise InvalidRequestError(
                "当前 YOLOv8 segmentation predictor 仅支持 onnxruntime runtime_backend",
        ...
        if runtime_target.runtime_precision != "fp32":
            raise InvalidRequestError(
                "当前 YOLOv8 segmentation onnxruntime session 仅支持 fp32 precision",
                details={"runtime_precision": runtime_target.runtime_precision},
            )

        imports = require_yolov8_segmentation_inference_imports()
        onnxruntime_module = import_yolov8_segmentation_onnxruntime_module()
        providers = resolve_yolov8_segmentation_onnxruntime_providers(
    ...
    def predict(
        ...
        """执行一次 ONNXRuntime YOLOv8 segmentation 预测。"""
...
__all__ = ["OnnxRuntimeYoloV8SegmentationRuntimeSession"]
