"""YOLOv8 classification OpenVINO runtime session。"""
...
class OpenVINOYoloV8ClassificationRuntimeSession:
    ...
    def __init__(
        ...
        *,
        ...
        """初始化 OpenVINO YOLOv8 classification 会话。"""
        ...
        *,
        ...
        if runtime_target.runtime_backend != "openvino":
            raise InvalidRequestError(
                "当前 YOLOv8 classification predictor 仅支持 openvino runtime_backend",
        ...
        imports = require_yolov8_classification_inference_imports()
        openvino_module = import_yolov8_classification_openvino_module()
        compiled_device_name = resolve_yolov8_classification_openvino_device_name(
            requested_device_name=runtime_target.device_name,
        )
        compile_properties = build_yolov8_classification_openvino_compile_properties(
        ...
        return cls(
            ...
            compiled_runtime_precision=resolve_yolov8_classification_openvino_compiled_runtime_precision(
                session=session,
    ...
    def predict(
        ...
        """执行一次 OpenVINO YOLOv8 classification 预测。"""
        ...
        raw_output = resolve_yolov8_classification_single_output(
            outputs=outputs,
...
__all__ = ["OpenVINOYoloV8ClassificationRuntimeSession"]
