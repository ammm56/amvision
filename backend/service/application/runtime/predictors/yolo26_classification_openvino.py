"""YOLO26 classification OpenVINO runtime session。"""
...
class OpenVINOYolo26ClassificationRuntimeSession:
    ...
    def __init__(
        ...
        *,
        ...
        """初始化 OpenVINO YOLO26 classification 会话。"""
    ...
    def load(
        ...
        *,
        ...
        """加载一套 OpenVINO YOLO26 classification 会话。"""

        if runtime_target.runtime_backend != "openvino":
            raise InvalidRequestError(
                "当前 YOLO26 classification predictor 仅支持 openvino runtime_backend",
        ...
        imports = require_yolo26_classification_inference_imports()
        openvino_module = import_yolo26_classification_openvino_module()
        compiled_device_name = resolve_yolo26_classification_openvino_device_name(
            requested_device_name=runtime_target.device_name,
        )
        compile_properties = build_yolo26_classification_openvino_compile_properties(
        ...
        return cls(
            ...
            input_name=resolve_yolo26_classification_openvino_port_name(
                input_port, fallback="images"
            ),
            output_name=resolve_yolo26_classification_openvino_port_name(
                output_port,
            ...
            compiled_runtime_precision=resolve_yolo26_classification_openvino_compiled_runtime_precision(
                session=session,
    ...
    def predict(
        ...
        """执行一次 OpenVINO YOLO26 classification 预测。"""
        ...
        raw_output = resolve_yolo26_classification_single_output(
            outputs=outputs,
        ...
        return Yolo26ClassificationPredictionExecutionResult(
            ...
            runtime_session_info=Yolo26ClassificationRuntimeSessionInfo(
                ...
                input_spec=Yolo26ClassificationRuntimeTensorSpec(
                    ...
                    dtype=resolve_yolo26_classification_openvino_port_dtype(
                        self.input_port,
                        fallback="float32",
                    ),
                ),
...
__all__ = ["OpenVINOYolo26ClassificationRuntimeSession"]
