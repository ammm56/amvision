"""YOLO26 detection ONNXRuntime runtime session。"""
...
class OnnxRuntimeYolo26RuntimeSession:
    ...
    def __init__(
        ...
        *,
        ...
        """初始化 ONNXRuntime YOLO26 detection 会话。"""
    ...
    def load(
        ...
        *,
        ...
        """加载一套 ONNXRuntime YOLO26 detection 会话。"""

        if runtime_target.runtime_backend != "onnxruntime":
            raise InvalidRequestError(
                "当前 YOLO26 detection predictor 仅支持 onnxruntime runtime_backend",
    ...
    def predict(
        ...
        """执行一次 ONNXRuntime YOLO26 detection 预测。"""
...
__all__ = ["OnnxRuntimeYolo26RuntimeSession"]
