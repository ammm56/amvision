...
from backend.service.application.runtime.predictors.yolo26.detection import (
...
from backend.service.application.runtime.predictors.yolov8.detection import (
