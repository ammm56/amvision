...
class SqlAlchemyYoloV8RuntimeTargetResolver(SqlAlchemyYoloXRuntimeTargetResolver):
    """复用 detection 共用解析链的 YOLOv8 detection 运行时快照解析器。"""

    def __init__(self, *, session_factory: SessionFactory, dataset_storage: LocalDatasetStorage) -> None:
        """初始化 YOLOv8 detection 运行时快照解析器。"""
