...
class OpenVINORfdetrSegmentationRuntimeSession:
    ...
    def load(
        ...
        *,
        ...
        resolved_output_names = _resolve_rfdetr_output_names(all_output_names)
        output_ports = tuple(
...
def _resolve_rfdetr_output_names(output_names: tuple[str, ...]) -> tuple[str, str, str]:
