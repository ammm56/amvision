...
BACKEND_WORKER_CONSUMER_RESOURCE_CLEANUP = "resource-cleanup"
BACKEND_WORKER_CONSUMER_MODEL_TRANSFER = "model-deployment-transfer"
...
SUPPORTED_BACKEND_WORKER_CONSUMER_KINDS = frozenset(
    (
        ...
        BACKEND_WORKER_CONSUMER_RESOURCE_CLEANUP,
        BACKEND_WORKER_CONSUMER_MODEL_TRANSFER,
