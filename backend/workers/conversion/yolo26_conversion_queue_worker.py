...
class Yolo26ConversionQueueWorker:
    """消费 yolo26-conversions 队列任务的最小 worker。"""
    ...
    def __init__(
        ...
        *,
        ...
        worker_id: str = "yolo26-conversion-worker",
    ) -> None:
        """初始化 YOLO26 转换队列 worker。"""
    ...
    def run_once(self) -> bool:
        ...
        try:
            ...
            service = SqlAlchemyYolo26ConversionTaskService(
                session_factory=self.session_factory,
                dataset_storage=self.dataset_storage,
                conversion_runner=self.conversion_runner
                or LocalYolo26ConversionRunner(dataset_storage=self.dataset_storage),
            )
