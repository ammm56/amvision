"""YOLOv8 训练 worker 接口与 SQLAlchemy 实现。"""
...
YoloV8TrainingRunRequest = TrainingBackendRunRequest
YoloV8TrainingRunResult = TrainingBackendRunResult
YoloV8TrainerRunner = TrainingBackend


class SqlAlchemyYoloV8TrainerRunner:
    """基于 SQLAlchemy 与本地文件存储的 YOLOv8 训练 worker。"""
    ...
    def __init__(
        ...
        *,
        ...
        """初始化 YOLOv8 训练 worker。"""

        self.session_factory = session_factory
        self.dataset_storage = dataset_storage

    def run_training(self, request: YoloV8TrainingRunRequest) -> YoloV8TrainingRunResult:
        """执行 YOLOv8 训练处理链路并返回结果。"""
