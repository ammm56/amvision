...
class YoloV8TrainingQueueWorker:
    """消费 yolov8-trainings 队列任务的最小 worker。"""
    ...
    def __init__(
        ...
        *,
        ...
        worker_id: str = "yolov8-training-worker",
    ) -> None:
        """初始化 YOLOv8 训练队列 worker。"""
    ...
    def run_once(self) -> bool:
        """消费并执行一条 YOLOv8 训练队列任务。"""

        queue_task = claim_next_training_queue(
            self.queue_backend,
            queue_names=(YOLOV8_TRAINING_QUEUE_NAME,),
