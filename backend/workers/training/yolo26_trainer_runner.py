"""YOLO26 训练 worker 接口与 SQLAlchemy 实现。"""
...
Yolo26TrainingRunResult = TrainingBackendRunResult
Yolo26TrainerRunner = TrainingBackend


class SqlAlchemyYolo26TrainerRunner:
    """基于 SQLAlchemy 与本地文件存储的 YOLO26 训练 worker。"""
