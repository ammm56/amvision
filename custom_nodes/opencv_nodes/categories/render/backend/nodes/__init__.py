...
from custom_nodes.opencv_nodes.categories.render.backend.nodes.draw_circles import (
    NODE_TYPE_ID as DRAW_CIRCLES_NODE_TYPE_ID,
    handle_node as draw_circles_handler,
)
from custom_nodes.opencv_nodes.categories.render.backend.nodes.draw_contours import (
    NODE_TYPE_ID as DRAW_CONTOURS_NODE_TYPE_ID,
    handle_node as draw_contours_handler,
)
from custom_nodes.opencv_nodes.categories.render.backend.nodes.draw_detections import (
    NODE_TYPE_ID as DRAW_DETECTIONS_NODE_TYPE_ID,
    handle_node as draw_detections_handler,
)
from custom_nodes.opencv_nodes.categories.render.backend.nodes.draw_lines import (
...
from custom_nodes.opencv_nodes.categories.render.backend.nodes.draw_roi import (
