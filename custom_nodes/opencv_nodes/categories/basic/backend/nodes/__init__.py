...
from custom_nodes.opencv_nodes.categories.basic.backend.nodes.adaptive_threshold import (
    NODE_TYPE_ID as ADAPTIVE_THRESHOLD_NODE_TYPE_ID,
    handle_node as adaptive_threshold_handler,
)
from custom_nodes.opencv_nodes.categories.basic.backend.nodes.binary_threshold import (
    NODE_TYPE_ID as BINARY_THRESHOLD_NODE_TYPE_ID,
    handle_node as binary_threshold_handler,
)
from custom_nodes.opencv_nodes.categories.basic.backend.nodes.canny import (
    NODE_TYPE_ID as CANNY_NODE_TYPE_ID,
    handle_node as canny_handler,
)
from custom_nodes.opencv_nodes.categories.basic.backend.nodes.bilateral_filter import (
    NODE_TYPE_ID as BILATERAL_FILTER_NODE_TYPE_ID,
    handle_node as bilateral_filter_handler,
)
from custom_nodes.opencv_nodes.categories.basic.backend.nodes.clahe import (
    NODE_TYPE_ID as CLAHE_NODE_TYPE_ID,
    handle_node as clahe_handler,
)
from custom_nodes.opencv_nodes.categories.basic.backend.nodes.crop_export import (
    NODE_TYPE_ID as CROP_EXPORT_NODE_TYPE_ID,
    handle_node as crop_export_handler,
)
from custom_nodes.opencv_nodes.categories.basic.backend.nodes.crop import (
    NODE_TYPE_ID as CROP_NODE_TYPE_ID,
    handle_node as crop_handler,
)
from custom_nodes.opencv_nodes.categories.basic.backend.nodes.gallery_preview import (
    NODE_TYPE_ID as GALLERY_PREVIEW_NODE_TYPE_ID,
    handle_node as gallery_preview_handler,
)
from custom_nodes.opencv_nodes.categories.basic.backend.nodes.gaussian_blur import (
    NODE_TYPE_ID as GAUSSIAN_BLUR_NODE_TYPE_ID,
    handle_node as gaussian_blur_handler,
)
from custom_nodes.opencv_nodes.categories.basic.backend.nodes.grayscale import (
    NODE_TYPE_ID as GRAYSCALE_NODE_TYPE_ID,
    handle_node as grayscale_handler,
)
from custom_nodes.opencv_nodes.categories.basic.backend.nodes.image_refs_statistics import (
    NODE_TYPE_ID as IMAGE_REFS_STATISTICS_NODE_TYPE_ID,
    handle_node as image_refs_statistics_handler,
)
from custom_nodes.opencv_nodes.categories.basic.backend.nodes.image_refs_slot_metrics import (
    NODE_TYPE_ID as IMAGE_REFS_SLOT_METRICS_NODE_TYPE_ID,
    handle_node as image_refs_slot_metrics_handler,
)
from custom_nodes.opencv_nodes.categories.basic.backend.nodes.image_refs_empty_check import (
    NODE_TYPE_ID as IMAGE_REFS_EMPTY_CHECK_NODE_TYPE_ID,
    handle_node as image_refs_empty_check_handler,
)
from custom_nodes.opencv_nodes.categories.basic.backend.nodes.image_refs_occupied_check import (
    NODE_TYPE_ID as IMAGE_REFS_OCCUPIED_CHECK_NODE_TYPE_ID,
    handle_node as image_refs_occupied_check_handler,
)
from custom_nodes.opencv_nodes.categories.basic.backend.nodes.invert import (
    NODE_TYPE_ID as INVERT_NODE_TYPE_ID,
    handle_node as invert_handler,
)
from custom_nodes.opencv_nodes.categories.basic.backend.nodes.laplacian import (
    NODE_TYPE_ID as LAPLACIAN_NODE_TYPE_ID,
    handle_node as laplacian_handler,
)
from custom_nodes.opencv_nodes.categories.basic.backend.nodes.median_blur import (
    NODE_TYPE_ID as MEDIAN_BLUR_NODE_TYPE_ID,
    handle_node as median_blur_handler,
)
from custom_nodes.opencv_nodes.categories.basic.backend.nodes.morphology import (
    NODE_TYPE_ID as MORPHOLOGY_NODE_TYPE_ID,
    handle_node as morphology_handler,
)
from custom_nodes.opencv_nodes.categories.basic.backend.nodes.normalize import (
    NODE_TYPE_ID as NORMALIZE_NODE_TYPE_ID,
    handle_node as normalize_handler,
)
from custom_nodes.opencv_nodes.categories.basic.backend.nodes.otsu_threshold import (
...
from custom_nodes.opencv_nodes.categories.basic.backend.nodes.resize import (
    NODE_TYPE_ID as RESIZE_NODE_TYPE_ID,
    handle_node as resize_handler,
)
from custom_nodes.opencv_nodes.categories.basic.backend.nodes.sobel import (
    NODE_TYPE_ID as SOBEL_NODE_TYPE_ID,
    handle_node as sobel_handler,
)
from custom_nodes.opencv_nodes.categories.basic.backend.nodes.slot_batch_state import (
