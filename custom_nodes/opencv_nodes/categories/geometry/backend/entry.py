"""OpenCV 几何节点包的 backend entrypoint。"""
...
from custom_nodes.opencv_nodes.categories.geometry.backend.nodes import NODE_HANDLERS


def register(context: NodePackEntrypointRegistrationContext) -> None:
    """把 OpenCV 几何节点 handler 注册到 workflow 运行时注册表。
