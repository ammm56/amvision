...
NODE_TYPE_ID = "custom.barcode.isbn-decode"


NODE_DEFINITION_PAYLOAD = {'format_id': 'amvision.node-definition.v1',
 'node_type_id': 'custom.barcode.isbn-decode',
 'display_name': 'ISBN Decode',
 'category': 'barcode.decode',
 'description': '从输入图片中解码 ISBN 图书条码。',
 ...
 'capability_tags': ['barcode.decode', 'barcode.isbn'],
 ...
 'metadata': {'family': 'retail',
              'variant': 'isbn',
              'scope_kind': 'exact',
              'format_member_name': 'ISBN'}}


handle_node = build_decode_handler(format_member_name="ISBN", requested_format="ISBN")
