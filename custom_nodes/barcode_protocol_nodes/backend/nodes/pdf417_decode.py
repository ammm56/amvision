...
NODE_TYPE_ID = "custom.barcode.pdf417-decode"


NODE_DEFINITION_PAYLOAD = {'format_id': 'amvision.node-definition.v1',
 'node_type_id': 'custom.barcode.pdf417-decode',
 'display_name': 'PDF417 Decode',
 'category': 'barcode.decode',
 'description': '从输入图片中解码 PDF417。',
 ...
 'capability_tags': ['barcode.decode', 'barcode.pdf417'],
 ...
 'metadata': {'family': 'matrix',
              'variant': 'pdf417',
              'scope_kind': 'exact',
              'format_member_name': 'PDF417'}}


handle_node = build_decode_handler(format_member_name="PDF417", requested_format="PDF417")
