...
NODE_TYPE_ID = "custom.barcode.code39-extended-decode"


NODE_DEFINITION_PAYLOAD = {'format_id': 'amvision.node-definition.v1',
 'node_type_id': 'custom.barcode.code39-extended-decode',
 'display_name': 'Code 39 Extended Decode',
 'category': 'barcode.decode',
 'description': '从输入图片中解码 Code 39 Extended 条码。',
 ...
 'capability_tags': ['barcode.decode', 'barcode.code39-extended'],
 ...
 'metadata': {'family': 'industrial',
              'variant': 'code39-extended',
              'scope_kind': 'exact',
              'format_member_name': 'Code39Ext'}}


handle_node = build_decode_handler(format_member_name="Code39Ext", requested_format="Code 39 Extended")
