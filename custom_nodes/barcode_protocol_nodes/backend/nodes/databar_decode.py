...
NODE_TYPE_ID = "custom.barcode.databar-decode"


NODE_DEFINITION_PAYLOAD = {'format_id': 'amvision.node-definition.v1',
 'node_type_id': 'custom.barcode.databar-decode',
 'display_name': 'Decode DataBar Family',
 'category': 'barcode.decode',
 'description': '扫描输入图片中的 DataBar 家族条码，适合 GS1 零售与扩展属性识读场景。',
 ...
 'capability_tags': ['barcode.decode', 'barcode.databar-family'],
 ...
 'metadata': {'family': 'retail',
              'variant': 'databar-family',
              'scope_kind': 'group',
              'format_member_name': 'DataBar'}}


handle_node = build_decode_handler(format_member_name="DataBar", requested_format="DataBar Family")
