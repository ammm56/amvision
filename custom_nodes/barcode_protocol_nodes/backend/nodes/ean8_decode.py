...
NODE_DEFINITION_PAYLOAD = {'format_id': 'amvision.node-definition.v1',
 'node_type_id': 'custom.barcode.ean8-decode',
 'display_name': 'EAN-8 Decode',
 'category': 'barcode.decode',
 'description': '从输入图片中解码 EAN-8 条码。',
 ...
 'capability_tags': ['barcode.decode', 'barcode.ean8'],
 ...
 'metadata': {'family': 'retail',
              'variant': 'ean8',
              'scope_kind': 'exact',
              'format_member_name': 'EAN8'}}


handle_node = build_decode_handler(format_member_name="EAN8", requested_format="EAN-8")
