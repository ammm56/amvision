...
NODE_TYPE_ID = "custom.barcode.qr-code-decode"


NODE_DEFINITION_PAYLOAD = {'format_id': 'amvision.node-definition.v1',
 'node_type_id': 'custom.barcode.qr-code-decode',
 'display_name': 'QR Code Decode',
 'category': 'barcode.decode',
 'description': '从输入图片中解码 QR Code，覆盖常规 QR Code 识读场景。',
 ...
 'capability_tags': ['barcode.decode', 'barcode.qr-code'],
 ...
 'metadata': {'family': 'matrix',
              'variant': 'qr-code',
              'scope_kind': 'exact',
              'format_member_name': 'QRCode'}}


handle_node = build_decode_handler(format_member_name="QRCode", requested_format="QR Code")
