...
NODE_TYPE_ID = "custom.barcode.itf-decode"


NODE_DEFINITION_PAYLOAD = {'format_id': 'amvision.node-definition.v1',
 'node_type_id': 'custom.barcode.itf-decode',
 'display_name': 'ITF Decode',
 'category': 'barcode.decode',
 'description': '从输入图片中解码 ITF 条码。',
 ...
 'capability_tags': ['barcode.decode', 'barcode.itf'],
 ...
 'metadata': {'family': 'industrial',
              'variant': 'itf',
              'scope_kind': 'exact',
              'format_member_name': 'ITF'}}


handle_node = build_decode_handler(format_member_name="ITF", requested_format="ITF")
