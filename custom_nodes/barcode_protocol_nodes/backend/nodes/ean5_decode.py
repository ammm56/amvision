...
NODE_TYPE_ID = "custom.barcode.ean5-decode"


NODE_DEFINITION_PAYLOAD = {'format_id': 'amvision.node-definition.v1',
 'node_type_id': 'custom.barcode.ean5-decode',
 'display_name': 'EAN-5 Decode',
 'category': 'barcode.decode',
 'description': '从输入图片中解码 EAN-5 附加码。',
 ...
 'capability_tags': ['barcode.decode', 'barcode.ean5'],
 ...
 'metadata': {'family': 'retail',
              'variant': 'ean5',
              'scope_kind': 'exact',
              'format_member_name': 'EAN5'}}


handle_node = build_decode_handler(format_member_name="EAN5", requested_format="EAN-5")
