...
NODE_TYPE_ID = "custom.barcode.maxicode-decode"


NODE_DEFINITION_PAYLOAD = {'format_id': 'amvision.node-definition.v1',
 'node_type_id': 'custom.barcode.maxicode-decode',
 'display_name': 'MaxiCode Decode',
 'category': 'barcode.decode',
 'description': '从输入图片中解码 MaxiCode；当前运行时以 partial read support 为主。',
 ...
 'capability_tags': ['barcode.decode', 'barcode.maxicode'],
 ...
 'metadata': {'family': 'matrix',
              'variant': 'maxicode',
              'scope_kind': 'exact',
              'format_member_name': 'MaxiCode'}}


handle_node = build_decode_handler(format_member_name="MaxiCode", requested_format="MaxiCode")
