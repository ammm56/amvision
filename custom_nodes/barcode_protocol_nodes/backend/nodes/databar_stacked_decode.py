...
NODE_TYPE_ID = "custom.barcode.databar-stacked-decode"


NODE_DEFINITION_PAYLOAD = {'format_id': 'amvision.node-definition.v1',
 'node_type_id': 'custom.barcode.databar-stacked-decode',
 'display_name': 'DataBar Stacked Decode',
 'category': 'barcode.decode',
 'description': '从输入图片中解码 DataBar Stacked 条码。',
 ...
 'capability_tags': ['barcode.decode', 'barcode.databar-stacked'],
 ...
 'metadata': {'family': 'retail',
              'variant': 'databar-stacked',
              'scope_kind': 'exact',
              'format_member_name': 'DataBarStk'}}


handle_node = build_decode_handler(format_member_name="DataBarStk", requested_format="DataBar Stacked")
