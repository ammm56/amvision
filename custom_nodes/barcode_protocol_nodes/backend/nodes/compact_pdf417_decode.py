...
NODE_TYPE_ID = "custom.barcode.compact-pdf417-decode"


NODE_DEFINITION_PAYLOAD = {'format_id': 'amvision.node-definition.v1',
 'node_type_id': 'custom.barcode.compact-pdf417-decode',
 'display_name': 'Compact PDF417 Decode',
 'category': 'barcode.decode',
 'description': '从输入图片中解码 Compact PDF417。',
 ...
 'capability_tags': ['barcode.decode', 'barcode.compact-pdf417'],
 ...
 'metadata': {'family': 'matrix',
              'variant': 'compact-pdf417',
              'scope_kind': 'exact',
              'format_member_name': 'CompactPDF417'}}


handle_node = build_decode_handler(format_member_name="CompactPDF417", requested_format="Compact PDF417")
