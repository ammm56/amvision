...
NODE_TYPE_ID = "custom.barcode.codabar-decode"


NODE_DEFINITION_PAYLOAD = {'format_id': 'amvision.node-definition.v1',
 'node_type_id': 'custom.barcode.codabar-decode',
 'display_name': 'Codabar Decode',
 'category': 'barcode.decode',
 'description': '从输入图片中解码 Codabar 条码。',
 ...
 'capability_tags': ['barcode.decode', 'barcode.codabar'],
 ...
 'metadata': {'family': 'industrial',
              'variant': 'codabar',
              'scope_kind': 'exact',
              'format_member_name': 'Codabar'}}


handle_node = build_decode_handler(format_member_name="Codabar", requested_format="Codabar")
