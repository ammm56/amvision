...
NODE_DEFINITION_PAYLOAD = {'format_id': 'amvision.node-definition.v1',
 'node_type_id': 'custom.barcode.code93-decode',
 'display_name': 'Code 93 Decode',
 'category': 'barcode.decode',
 'description': '从输入图片中解码 Code 93 条码。',
 ...
 'capability_tags': ['barcode.decode', 'barcode.code93'],
 ...
 'metadata': {'family': 'industrial',
              'variant': 'code93',
              'scope_kind': 'exact',
              'format_member_name': 'Code93'}}


handle_node = build_decode_handler(format_member_name="Code93", requested_format="Code 93")
