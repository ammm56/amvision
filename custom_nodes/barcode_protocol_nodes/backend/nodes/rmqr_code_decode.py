...
NODE_TYPE_ID = "custom.barcode.rmqr-code-decode"


NODE_DEFINITION_PAYLOAD = {'format_id': 'amvision.node-definition.v1',
 'node_type_id': 'custom.barcode.rmqr-code-decode',
 'display_name': 'rMQR Decode',
 'category': 'barcode.decode',
 'description': '从输入图片中解码 rMQR。',
 ...
 'capability_tags': ['barcode.decode', 'barcode.rmqr'],
 ...
 'metadata': {'family': 'matrix',
              'variant': 'rmqr',
              'scope_kind': 'exact',
              'format_member_name': 'RMQRCode'}}


handle_node = build_decode_handler(format_member_name="RMQRCode", requested_format="rMQR")
