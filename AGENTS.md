...
- 不承载详细目录层级、模块展开或子系统深入设计；详细结构方案见 [docs/architecture/project-structure.md](docs/architecture/project-structure.md)
...
- FastAPI 负责后端服务和集成面，训练、推理、转换、流程执行通过任务系统或 worker 承载
