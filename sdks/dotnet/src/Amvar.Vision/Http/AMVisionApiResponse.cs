...
namespace Amvar.Vision
{
    ...
    /// </summary>
    public sealed class AMVisionApiResponse
    {
        private AMVisionApiResponse(
        ...
        /// <summary>
        /// 非 2xx 响应时抛出 <see cref="AMVisionApiException" />。
        /// </summary>
        public void EnsureSuccessStatusCode()
        {
            ...
            throw new AMVisionApiException(
                StatusCode,
                ErrorCode,
        ...
        internal static AMVisionApiResponse Create(HttpStatusCode statusCode, string content)
        {
        ...
        /// <returns>解析后的 SDK 响应。</returns>
        internal static AMVisionApiResponse Create(
            HttpStatusCode statusCode,
            string content,
            string? httpMethod,
            string? requestPath)
        {
            ...
            return new AMVisionApiResponse(
                statusCode,
                content,
                bodyJson,
                errorCode,
