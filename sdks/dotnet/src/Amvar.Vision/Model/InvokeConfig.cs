...
internal sealed class InvokeConfig
{
    ...
    /// </summary>
    [JsonProperty("image_input_binding")]
    ...
    /// 控制台输出事件预览时展示的条数。
    /// </summary>
    [JsonProperty("event_preview_count")]
