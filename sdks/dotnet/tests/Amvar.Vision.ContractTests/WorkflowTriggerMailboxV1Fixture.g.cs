...
namespace Amvar.Vision.ContractTests
{
    internal static class WorkflowTriggerMailboxV1Fixture
    {
        internal static void Verify()
        {
            ...
            AssertHex(BuildDescriptorHeader(), "", "descriptor header");
        ...
        private static byte[] BuildDescriptorHeader()
        {
            ...
            WriteUInt32(buffer, WorkflowTriggerMailboxV1.DescriptorHeaderCancelRequestedOffset, 0U);
